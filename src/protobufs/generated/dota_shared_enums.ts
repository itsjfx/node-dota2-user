...
export const CDOTAClientHardwareSpecs: MessageFns<CDOTAClientHardwareSpecs> = {
  encode(message: CDOTAClientHardwareSpecs, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CDOTAClientHardwareSpecs {
...
export const CDOTASaveGame: MessageFns<CDOTASaveGame> = {
  encode(message: CDOTASaveGame, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.players) {
      CDOTASaveGame_Player.encode(v!, writer.uint32(26).fork()).join();
    }
    for (const v of message.saveInstances) {
      CDOTASaveGame_SaveInstance.encode(v!, writer.uint32(34).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CDOTASaveGame {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): CDOTASaveGame {
    return {
      ...
      players: globalThis.Array.isArray(object?.players)
        ? object.players.map((e: any) => CDOTASaveGame_Player.fromJSON(e))
        : [],
  ...
  toJSON(message: CDOTASaveGame): unknown {
    ...
    if (message.players?.length) {
      obj.players = message.players.map((e) => CDOTASaveGame_Player.toJSON(e));
    }
    if (message.saveInstances?.length) {
      obj.saveInstances = message.saveInstances.map((e) => CDOTASaveGame_SaveInstance.toJSON(e));
    }
    return obj;
  },
...
export const CDOTASaveGame_Player: MessageFns<CDOTASaveGame_Player> = {
  encode(message: CDOTASaveGame_Player, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.team !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CDOTASaveGame_Player {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CDOTASaveGame_SaveInstance: MessageFns<CDOTASaveGame_SaveInstance> = {
  encode(message: CDOTASaveGame_SaveInstance, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.playerPositions) {
      CDOTASaveGame_SaveInstance_PlayerPositions.encode(v!, writer.uint32(42).fork()).join();
    }
    if (message.saveId !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CDOTASaveGame_SaveInstance {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: CDOTASaveGame_SaveInstance): unknown {
    ...
    if (message.playerPositions?.length) {
      obj.playerPositions = message.playerPositions.map((e) => CDOTASaveGame_SaveInstance_PlayerPositions.toJSON(e));
    }
    if (message.saveId !== 0) {
...
export const CDOTASaveGame_SaveInstance_PlayerPositions: MessageFns<CDOTASaveGame_SaveInstance_PlayerPositions> = {
  encode(message: CDOTASaveGame_SaveInstance_PlayerPositions, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.x !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CDOTASaveGame_SaveInstance_PlayerPositions {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgDOTACombatLogEntry: MessageFns<CMsgDOTACombatLogEntry> = {
  encode(message: CMsgDOTACombatLogEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.type !== -1) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgDOTACombatLogEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): CMsgDOTACombatLogEntry {
    return {
      ...
      assistPlayers: globalThis.Array.isArray(object?.assistPlayers)
        ? object.assistPlayers.map((e: any) => globalThis.Number(e))
        : [],
...
export const CMsgPendingEventAward: MessageFns<CMsgPendingEventAward> = {
  encode(message: CMsgPendingEventAward, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgPendingEventAward {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
