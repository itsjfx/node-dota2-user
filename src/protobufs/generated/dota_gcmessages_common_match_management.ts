...
export const CSODOTAPartyMember: MessageFns<CSODOTAPartyMember> = {
  encode(message: CSODOTAPartyMember, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CSODOTAPartyMember {
  ...
  fromJSON(object: any): CSODOTAPartyMember {
    return {
      ...
      regionPingCodes: globalThis.Array.isArray(object?.regionPingCodes)
        ? object.regionPingCodes.map((e: any) => globalThis.Number(e))
        : [],
      regionPingTimes: globalThis.Array.isArray(object?.regionPingTimes)
        ? object.regionPingTimes.map((e: any) => globalThis.Number(e))
        : [],
...
export const CSODOTAParty: MessageFns<CSODOTAParty> = {
  encode(message: CSODOTAParty, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.members) {
      CSODOTAPartyMember.encode(v!, writer.uint32(234).fork()).join();
    }
    ...
    for (const v of message.sentInvites) {
      CSODOTAPartyInvite.encode(v!, writer.uint32(330).fork()).join();
    }
    for (const v of message.recvInvites) {
      CSODOTAPartyInvite.encode(v!, writer.uint32(338).fork()).join();
    }
    ...
    if (message.readyCheck !== undefined) {
      CMsgReadyCheckStatus.encode(message.readyCheck, writer.uint32(498).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CSODOTAParty {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): CSODOTAParty {
    return {
      ...
      members: globalThis.Array.isArray(object?.members)
        ? object.members.map((e: any) => CSODOTAPartyMember.fromJSON(e))
        : [],
  ...
  toJSON(message: CSODOTAParty): unknown {
    ...
    if (message.members?.length) {
      obj.members = message.members.map((e) => CSODOTAPartyMember.toJSON(e));
    }
    if (message.lowPriorityGamesRemaining !== 0) {
    ...
    if (message.sentInvites?.length) {
      obj.sentInvites = message.sentInvites.map((e) => CSODOTAPartyInvite.toJSON(e));
    }
    if (message.recvInvites?.length) {
      obj.recvInvites = message.recvInvites.map((e) => CSODOTAPartyInvite.toJSON(e));
    }
    if (message.accountFlags !== 0) {
    ...
    if (message.readyCheck !== undefined) {
      obj.readyCheck = CMsgReadyCheckStatus.toJSON(message.readyCheck);
    }
    if (message.customGameDisabledUntilDate !== 0) {
...
export const CSODOTAPartyInvite: MessageFns<CSODOTAPartyInvite> = {
  encode(message: CSODOTAPartyInvite, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.members) {
      CSODOTAPartyInvite_PartyMember.encode(v!, writer.uint32(34).fork()).join();
    }
    if (message.teamId !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CSODOTAPartyInvite {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: CSODOTAPartyInvite): unknown {
    ...
    if (message.members?.length) {
      obj.members = message.members.map((e) => CSODOTAPartyInvite_PartyMember.toJSON(e));
    }
    if (message.teamId !== 0) {
      obj.teamId = Math.round(message.teamId);
    }
...
export const CSODOTAPartyInvite_PartyMember: MessageFns<CSODOTAPartyInvite_PartyMember> = {
  encode(message: CSODOTAPartyInvite_PartyMember, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CSODOTAPartyInvite_PartyMember {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgLeaverState: MessageFns<CMsgLeaverState> = {
  encode(message: CMsgLeaverState, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgLeaverState {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgReadyCheckStatus: MessageFns<CMsgReadyCheckStatus> = {
  encode(message: CMsgReadyCheckStatus, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.readyMembers) {
      CMsgReadyCheckStatus_ReadyMember.encode(v!, writer.uint32(34).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CMsgReadyCheckStatus {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: CMsgReadyCheckStatus): unknown {
    ...
    if (message.readyMembers?.length) {
      obj.readyMembers = message.readyMembers.map((e) => CMsgReadyCheckStatus_ReadyMember.toJSON(e));
    }
    return obj;
  },
...
export const CMsgReadyCheckStatus_ReadyMember: MessageFns<CMsgReadyCheckStatus_ReadyMember> = {
  encode(message: CMsgReadyCheckStatus_ReadyMember, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgReadyCheckStatus_ReadyMember {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgPartyReadyCheckRequest: MessageFns<CMsgPartyReadyCheckRequest> = {
  encode(_: CMsgPartyReadyCheckRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CMsgPartyReadyCheckRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgPartyReadyCheckResponse: MessageFns<CMsgPartyReadyCheckResponse> = {
  encode(message: CMsgPartyReadyCheckResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.result !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgPartyReadyCheckResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgPartyReadyCheckAcknowledge: MessageFns<CMsgPartyReadyCheckAcknowledge> = {
  encode(message: CMsgPartyReadyCheckAcknowledge, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.readyStatus !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgPartyReadyCheckAcknowledge {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgLobbyEventGameDetails: MessageFns<CMsgLobbyEventGameDetails> = {
  encode(message: CMsgLobbyEventGameDetails, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgLobbyEventGameDetails {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMsgMatchMatchmakingStats: MessageFns<CMsgMatchMatchmakingStats> = {
  encode(message: CMsgMatchMatchmakingStats, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMsgMatchMatchmakingStats {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMvpData: MessageFns<CMvpData> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMvpData {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CMvpData_MvpDatum: MessageFns<CMvpData_MvpDatum> = {
  encode(message: CMvpData_MvpDatum, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.playerSlot !== 0) {
      writer.uint32(8).uint32(message.playerSlot);
    }
    for (const v of message.accolades) {
      CMvpData_MvpDatum_MvpAccolade.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CMvpData_MvpDatum {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: CMvpData_MvpDatum): unknown {
    ...
    if (message.accolades?.length) {
      obj.accolades = message.accolades.map((e) => CMvpData_MvpDatum_MvpAccolade.toJSON(e));
    }
    return obj;
  },
...
export const CMvpData_MvpDatum_MvpAccolade: MessageFns<CMvpData_MvpDatum_MvpAccolade> = {
  encode(message: CMvpData_MvpDatum_MvpAccolade, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.type !== 1) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CMvpData_MvpDatum_MvpAccolade {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
