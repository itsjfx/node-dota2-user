...
(function(global, factory) { /* global define, require, module */
    ...
    $root.ChangeMapToolEvent = (function() {
    
        /**
         * Properties of a ChangeMapToolEvent.
         * @exports IChangeMapToolEvent
         * @interface IChangeMapToolEvent
         * @property {string|null} [mapname] ChangeMapToolEvent mapname
         */
    
        /**
         * Constructs a new ChangeMapToolEvent.
         * @exports ChangeMapToolEvent
         * @classdesc Represents a ChangeMapToolEvent.
         * @implements IChangeMapToolEvent
         * @constructor
         * @param {IChangeMapToolEvent=} [properties] Properties to set
         */
        function ChangeMapToolEvent(properties) {
            if (properties)
         ...
         * @memberof ChangeMapToolEvent
         * @instance
         */
        ChangeMapToolEvent.prototype.mapname = "";
    
        /**
         * Creates a new ChangeMapToolEvent instance using the specified properties.
         * @function create
         * @memberof ChangeMapToolEvent
         * @static
         * @param {IChangeMapToolEvent=} [properties] Properties to set
         * @returns {ChangeMapToolEvent} ChangeMapToolEvent instance
         */
        ChangeMapToolEvent.create = function create(properties) {
            return new ChangeMapToolEvent(properties);
        };
    
        /**
         * Encodes the specified ChangeMapToolEvent message. Does not implicitly {@link ChangeMapToolEvent.verify|verify} messages.
         * @function encode
         * @memberof ChangeMapToolEvent
         * @static
         * @param {IChangeMapToolEvent} message ChangeMapToolEvent message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        ChangeMapToolEvent.encode = function encode(message, writer) {
            if (!writer)
        ...
        /**
         * Encodes the specified ChangeMapToolEvent message, length delimited. Does not implicitly {@link ChangeMapToolEvent.verify|verify} messages.
         ...
         * @returns {$protobuf.Writer} Writer
         */
        ChangeMapToolEvent.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
    
        /**
         * Decodes a ChangeMapToolEvent message from the specified reader or buffer.
         * @function decode
         * @memberof ChangeMapToolEvent
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {ChangeMapToolEvent} ChangeMapToolEvent
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ChangeMapToolEvent.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ChangeMapToolEvent();
        ...
        /**
         * Decodes a ChangeMapToolEvent message from the specified reader or buffer, length delimited.
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ChangeMapToolEvent.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
        ...
        /**
         * Verifies a ChangeMapToolEvent message.
         * @function verify
         * @memberof ChangeMapToolEvent
         * @static
         ...
         */
        ChangeMapToolEvent.verify = function verify(message) {
        ...
        /**
         * Creates a ChangeMapToolEvent message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof ChangeMapToolEvent
         * @static
         ...
         * @returns {ChangeMapToolEvent} ChangeMapToolEvent
         */
        ChangeMapToolEvent.fromObject = function fromObject(object) {
            if (object instanceof $root.ChangeMapToolEvent)
                return object;
            var message = new $root.ChangeMapToolEvent();
        ...
        /**
         * Creates a plain object from a ChangeMapToolEvent message. Also converts values to other types if specified.
         * @function toObject
         * @memberof ChangeMapToolEvent
         * @static
         * @param {ChangeMapToolEvent} message ChangeMapToolEvent
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        ChangeMapToolEvent.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults)
        ...
        /**
         * Converts this ChangeMapToolEvent to JSON.
         * @function toJSON
         * @memberof ChangeMapToolEvent
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        ChangeMapToolEvent.prototype.toJSON = function toJSON() {
    ...
    $root.TraceRayServerToolEvent = (function() {
    
        /**
         * Properties of a TraceRayServerToolEvent.
         * @exports ITraceRayServerToolEvent
         * @interface ITraceRayServerToolEvent
         * @property {ICMsgVector|null} [start] TraceRayServerToolEvent start
         * @property {ICMsgVector|null} [end] TraceRayServerToolEvent end
         */
    
        /**
         * Constructs a new TraceRayServerToolEvent.
         * @exports TraceRayServerToolEvent
         * @classdesc Represents a TraceRayServerToolEvent.
         * @implements ITraceRayServerToolEvent
         * @constructor
         * @param {ITraceRayServerToolEvent=} [properties] Properties to set
         */
        function TraceRayServerToolEvent(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
        ...
        /**
         * TraceRayServerToolEvent start.
         * @member {ICMsgVector|null|undefined} start
         * @memberof TraceRayServerToolEvent
         * @instance
         */
        TraceRayServerToolEvent.prototype.start = null;
    
        /**
         * TraceRayServerToolEvent end.
         * @member {ICMsgVector|null|undefined} end
         * @memberof TraceRayServerToolEvent
         * @instance
         */
        TraceRayServerToolEvent.prototype.end = null;
    
        /**
         * Creates a new TraceRayServerToolEvent instance using the specified properties.
         * @function create
         * @memberof TraceRayServerToolEvent
         * @static
         * @param {ITraceRayServerToolEvent=} [properties] Properties to set
         * @returns {TraceRayServerToolEvent} TraceRayServerToolEvent instance
         */
        TraceRayServerToolEvent.create = function create(properties) {
            return new TraceRayServerToolEvent(properties);
        };
    
        /**
         * Encodes the specified TraceRayServerToolEvent message. Does not implicitly {@link TraceRayServerToolEvent.verify|verify} messages.
         * @function encode
         * @memberof TraceRayServerToolEvent
         * @static
         * @param {ITraceRayServerToolEvent} message TraceRayServerToolEvent message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        TraceRayServerToolEvent.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.start != null && Object.hasOwnProperty.call(message, "start"))
                $root.CMsgVector.encode(message.start, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            if (message.end != null && Object.hasOwnProperty.call(message, "end"))
                $root.CMsgVector.encode(message.end, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
            return writer;
        };
    
        /**
         * Encodes the specified TraceRayServerToolEvent message, length delimited. Does not implicitly {@link TraceRayServerToolEvent.verify|verify} messages.
         * @function encodeDelimited
         * @memberof TraceRayServerToolEvent
         * @static
         * @param {ITraceRayServerToolEvent} message TraceRayServerToolEvent message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        TraceRayServerToolEvent.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
    
        /**
         * Decodes a TraceRayServerToolEvent message from the specified reader or buffer.
         * @function decode
         * @memberof TraceRayServerToolEvent
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {TraceRayServerToolEvent} TraceRayServerToolEvent
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        TraceRayServerToolEvent.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.TraceRayServerToolEvent();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        /**
         * Decodes a TraceRayServerToolEvent message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof TraceRayServerToolEvent
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        TraceRayServerToolEvent.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a TraceRayServerToolEvent message.
         * @function verify
         * @memberof TraceRayServerToolEvent
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        TraceRayServerToolEvent.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
        ...
        /**
         * Creates a TraceRayServerToolEvent message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof TraceRayServerToolEvent
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {TraceRayServerToolEvent} TraceRayServerToolEvent
         */
        TraceRayServerToolEvent.fromObject = function fromObject(object) {
            if (object instanceof $root.TraceRayServerToolEvent)
                return object;
            var message = new $root.TraceRayServerToolEvent();
            if (object.start != null) {
                if (typeof object.start !== "object")
                    throw TypeError(".TraceRayServerToolEvent.start: object expected");
                message.start = $root.CMsgVector.fromObject(object.start);
            }
            if (object.end != null) {
                if (typeof object.end !== "object")
                    throw TypeError(".TraceRayServerToolEvent.end: object expected");
        ...
        /**
         * Creates a plain object from a TraceRayServerToolEvent message. Also converts values to other types if specified.
         * @function toObject
         * @memberof TraceRayServerToolEvent
         * @static
         * @param {TraceRayServerToolEvent} message TraceRayServerToolEvent
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        TraceRayServerToolEvent.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
        ...
        /**
         * Converts this TraceRayServerToolEvent to JSON.
         * @function toJSON
         * @memberof TraceRayServerToolEvent
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        TraceRayServerToolEvent.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    $root.ToolTraceRayResult = (function() {
    
        /**
         * Properties of a ToolTraceRayResult.
         * @exports IToolTraceRayResult
         * @interface IToolTraceRayResult
         * @property {boolean|null} [hit] ToolTraceRayResult hit
         * @property {ICMsgVector|null} [impact] ToolTraceRayResult impact
         * @property {ICMsgVector|null} [normal] ToolTraceRayResult normal
         * @property {number|null} [distance] ToolTraceRayResult distance
         * @property {number|null} [fraction] ToolTraceRayResult fraction
         * @property {number|null} [ehandle] ToolTraceRayResult ehandle
         */
    
        /**
         * Constructs a new ToolTraceRayResult.
         * @exports ToolTraceRayResult
         * @classdesc Represents a ToolTraceRayResult.
         * @implements IToolTraceRayResult
         * @constructor
         * @param {IToolTraceRayResult=} [properties] Properties to set
         */
        function ToolTraceRayResult(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
        ...
        /**
         * ToolTraceRayResult hit.
         * @member {boolean} hit
         * @memberof ToolTraceRayResult
         * @instance
         */
        ToolTraceRayResult.prototype.hit = false;
    
        /**
         * ToolTraceRayResult impact.
         * @member {ICMsgVector|null|undefined} impact
         * @memberof ToolTraceRayResult
         * @instance
         */
        ToolTraceRayResult.prototype.impact = null;
    
        /**
         * ToolTraceRayResult normal.
         * @member {ICMsgVector|null|undefined} normal
         * @memberof ToolTraceRayResult
         * @instance
         */
        ToolTraceRayResult.prototype.normal = null;
    
        /**
         * ToolTraceRayResult distance.
         * @member {number} distance
         * @memberof ToolTraceRayResult
         * @instance
         */
        ToolTraceRayResult.prototype.distance = 0;
    
        /**
         * ToolTraceRayResult fraction.
         * @member {number} fraction
         * @memberof ToolTraceRayResult
         * @instance
         */
        ToolTraceRayResult.prototype.fraction = 0;
    
        /**
         * ToolTraceRayResult ehandle.
         * @member {number} ehandle
         * @memberof ToolTraceRayResult
         * @instance
         */
        ToolTraceRayResult.prototype.ehandle = 0;
    
        /**
         * Creates a new ToolTraceRayResult instance using the specified properties.
         * @function create
         * @memberof ToolTraceRayResult
         * @static
         * @param {IToolTraceRayResult=} [properties] Properties to set
         * @returns {ToolTraceRayResult} ToolTraceRayResult instance
         */
        ToolTraceRayResult.create = function create(properties) {
            return new ToolTraceRayResult(properties);
        };
    
        /**
         * Encodes the specified ToolTraceRayResult message. Does not implicitly {@link ToolTraceRayResult.verify|verify} messages.
         * @function encode
         * @memberof ToolTraceRayResult
         * @static
         * @param {IToolTraceRayResult} message ToolTraceRayResult message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        ToolTraceRayResult.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            ...
            if (message.impact != null && Object.hasOwnProperty.call(message, "impact"))
                $root.CMsgVector.encode(message.impact, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
            ...
            if (message.fraction != null && Object.hasOwnProperty.call(message, "fraction"))
                writer.uint32(/* id 5, wireType 5 =*/45).float(message.fraction);
            if (message.ehandle != null && Object.hasOwnProperty.call(message, "ehandle"))
                writer.uint32(/* id 6, wireType 0 =*/48).int32(message.ehandle);
            return writer;
        };
    
        /**
         * Encodes the specified ToolTraceRayResult message, length delimited. Does not implicitly {@link ToolTraceRayResult.verify|verify} messages.
         * @function encodeDelimited
         * @memberof ToolTraceRayResult
         * @static
         * @param {IToolTraceRayResult} message ToolTraceRayResult message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        ToolTraceRayResult.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
    
        /**
         * Decodes a ToolTraceRayResult message from the specified reader or buffer.
         * @function decode
         * @memberof ToolTraceRayResult
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {ToolTraceRayResult} ToolTraceRayResult
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ToolTraceRayResult.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ToolTraceRayResult();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.impact = $root.CMsgVector.decode(reader, reader.uint32());
                    break;
                case 3:
        ...
        /**
         * Decodes a ToolTraceRayResult message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof ToolTraceRayResult
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ToolTraceRayResult.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a ToolTraceRayResult message.
         * @function verify
         * @memberof ToolTraceRayResult
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        ToolTraceRayResult.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            ...
            if (message.impact != null && message.hasOwnProperty("impact")) {
                var error = $root.CMsgVector.verify(message.impact);
                if (error)
                    return "impact." + error;
            }
        ...
        /**
         * Creates a ToolTraceRayResult message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof ToolTraceRayResult
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {ToolTraceRayResult} ToolTraceRayResult
         */
        ToolTraceRayResult.fromObject = function fromObject(object) {
            if (object instanceof $root.ToolTraceRayResult)
                return object;
            var message = new $root.ToolTraceRayResult();
            if (object.hit != null)
                message.hit = Boolean(object.hit);
            if (object.impact != null) {
                if (typeof object.impact !== "object")
                    throw TypeError(".ToolTraceRayResult.impact: object expected");
                message.impact = $root.CMsgVector.fromObject(object.impact);
            }
            if (object.normal != null) {
                if (typeof object.normal !== "object")
                    throw TypeError(".ToolTraceRayResult.normal: object expected");
        ...
        /**
         * Creates a plain object from a ToolTraceRayResult message. Also converts values to other types if specified.
         * @function toObject
         * @memberof ToolTraceRayResult
         * @static
         * @param {ToolTraceRayResult} message ToolTraceRayResult
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        ToolTraceRayResult.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
            ...
            if (message.impact != null && message.hasOwnProperty("impact"))
                object.impact = $root.CMsgVector.toObject(message.impact, options);
            if (message.normal != null && message.hasOwnProperty("normal"))
        ...
        /**
         * Converts this ToolTraceRayResult to JSON.
         * @function toJSON
         * @memberof ToolTraceRayResult
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        ToolTraceRayResult.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    $root.SpawnEntityToolEvent = (function() {
    
        /**
         * Properties of a SpawnEntityToolEvent.
         * @exports ISpawnEntityToolEvent
         * @interface ISpawnEntityToolEvent
         * @property {Uint8Array|null} [entity_keyvalues] SpawnEntityToolEvent entity_keyvalues
         * @property {boolean|null} [clientsideentity] SpawnEntityToolEvent clientsideentity
         */
    
        /**
         * Constructs a new SpawnEntityToolEvent.
         * @exports SpawnEntityToolEvent
         * @classdesc Represents a SpawnEntityToolEvent.
         * @implements ISpawnEntityToolEvent
         * @constructor
         * @param {ISpawnEntityToolEvent=} [properties] Properties to set
         */
        function SpawnEntityToolEvent(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
        ...
        /**
         * SpawnEntityToolEvent entity_keyvalues.
         * @member {Uint8Array} entity_keyvalues
         * @memberof SpawnEntityToolEvent
         * @instance
         */
        SpawnEntityToolEvent.prototype.entity_keyvalues = $util.newBuffer([]);
    
        /**
         * SpawnEntityToolEvent clientsideentity.
         * @member {boolean} clientsideentity
         * @memberof SpawnEntityToolEvent
         * @instance
         */
        SpawnEntityToolEvent.prototype.clientsideentity = false;
    
        /**
         * Creates a new SpawnEntityToolEvent instance using the specified properties.
         * @function create
         * @memberof SpawnEntityToolEvent
         * @static
         * @param {ISpawnEntityToolEvent=} [properties] Properties to set
         * @returns {SpawnEntityToolEvent} SpawnEntityToolEvent instance
         */
        SpawnEntityToolEvent.create = function create(properties) {
            return new SpawnEntityToolEvent(properties);
        };
    
        /**
         * Encodes the specified SpawnEntityToolEvent message. Does not implicitly {@link SpawnEntityToolEvent.verify|verify} messages.
         * @function encode
         * @memberof SpawnEntityToolEvent
         * @static
         * @param {ISpawnEntityToolEvent} message SpawnEntityToolEvent message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        SpawnEntityToolEvent.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.entity_keyvalues != null && Object.hasOwnProperty.call(message, "entity_keyvalues"))
                writer.uint32(/* id 1, wireType 2 =*/10).bytes(message.entity_keyvalues);
            if (message.clientsideentity != null && Object.hasOwnProperty.call(message, "clientsideentity"))
                writer.uint32(/* id 2, wireType 0 =*/16).bool(message.clientsideentity);
            return writer;
        };
    
        /**
         * Encodes the specified SpawnEntityToolEvent message, length delimited. Does not implicitly {@link SpawnEntityToolEvent.verify|verify} messages.
         * @function encodeDelimited
         * @memberof SpawnEntityToolEvent
         * @static
         * @param {ISpawnEntityToolEvent} message SpawnEntityToolEvent message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        SpawnEntityToolEvent.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
    
        /**
         * Decodes a SpawnEntityToolEvent message from the specified reader or buffer.
         * @function decode
         * @memberof SpawnEntityToolEvent
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {SpawnEntityToolEvent} SpawnEntityToolEvent
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        SpawnEntityToolEvent.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.SpawnEntityToolEvent();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
                    message.entity_keyvalues = reader.bytes();
                    break;
                case 2:
        ...
        /**
         * Decodes a SpawnEntityToolEvent message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof SpawnEntityToolEvent
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        SpawnEntityToolEvent.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a SpawnEntityToolEvent message.
         * @function verify
         * @memberof SpawnEntityToolEvent
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        SpawnEntityToolEvent.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.entity_keyvalues != null && message.hasOwnProperty("entity_keyvalues"))
                if (!(message.entity_keyvalues && typeof message.entity_keyvalues.length === "number" || $util.isString(message.entity_keyvalues)))
                    return "entity_keyvalues: buffer expected";
            if (message.clientsideentity != null && message.hasOwnProperty("clientsideentity"))
                if (typeof message.clientsideentity !== "boolean")
                    return "clientsideentity: boolean expected";
            return null;
        };
    
        /**
         * Creates a SpawnEntityToolEvent message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof SpawnEntityToolEvent
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {SpawnEntityToolEvent} SpawnEntityToolEvent
         */
        SpawnEntityToolEvent.fromObject = function fromObject(object) {
            if (object instanceof $root.SpawnEntityToolEvent)
                return object;
            var message = new $root.SpawnEntityToolEvent();
            if (object.entity_keyvalues != null)
                if (typeof object.entity_keyvalues === "string")
                    $util.base64.decode(object.entity_keyvalues, message.entity_keyvalues = $util.newBuffer($util.base64.length(object.entity_keyvalues)), 0);
                else if (object.entity_keyvalues.length)
                    message.entity_keyvalues = object.entity_keyvalues;
            if (object.clientsideentity != null)
                message.clientsideentity = Boolean(object.clientsideentity);
            return message;
        };
    
        /**
         * Creates a plain object from a SpawnEntityToolEvent message. Also converts values to other types if specified.
         * @function toObject
         * @memberof SpawnEntityToolEvent
         * @static
         * @param {SpawnEntityToolEvent} message SpawnEntityToolEvent
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        SpawnEntityToolEvent.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
                if (options.bytes === String)
                    object.entity_keyvalues = "";
                else {
                    object.entity_keyvalues = [];
                    if (options.bytes !== Array)
                        object.entity_keyvalues = $util.newBuffer(object.entity_keyvalues);
                }
                object.clientsideentity = false;
            }
            if (message.entity_keyvalues != null && message.hasOwnProperty("entity_keyvalues"))
                object.entity_keyvalues = options.bytes === String ? $util.base64.encode(message.entity_keyvalues, 0, message.entity_keyvalues.length) : options.bytes === Array ? Array.prototype.slice.call(message.entity_keyvalues) : message.entity_keyvalues;
            if (message.clientsideentity != null && message.hasOwnProperty("clientsideentity"))
                object.clientsideentity = message.clientsideentity;
            return object;
        };
    
        /**
         * Converts this SpawnEntityToolEvent to JSON.
         * @function toJSON
         * @memberof SpawnEntityToolEvent
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        SpawnEntityToolEvent.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    $root.SpawnEntityToolEventResult = (function() {
    
        /**
         * Properties of a SpawnEntityToolEventResult.
         * @exports ISpawnEntityToolEventResult
         * @interface ISpawnEntityToolEventResult
         * @property {number|null} [ehandle] SpawnEntityToolEventResult ehandle
         */
    
        /**
         * Constructs a new SpawnEntityToolEventResult.
         * @exports SpawnEntityToolEventResult
         * @classdesc Represents a SpawnEntityToolEventResult.
         * @implements ISpawnEntityToolEventResult
         * @constructor
         * @param {ISpawnEntityToolEventResult=} [properties] Properties to set
         */
        function SpawnEntityToolEventResult(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
        ...
        /**
         * SpawnEntityToolEventResult ehandle.
         * @member {number} ehandle
         * @memberof SpawnEntityToolEventResult
         * @instance
         */
        SpawnEntityToolEventResult.prototype.ehandle = 0;
    
        /**
         * Creates a new SpawnEntityToolEventResult instance using the specified properties.
         * @function create
         * @memberof SpawnEntityToolEventResult
         * @static
         * @param {ISpawnEntityToolEventResult=} [properties] Properties to set
         * @returns {SpawnEntityToolEventResult} SpawnEntityToolEventResult instance
         */
        SpawnEntityToolEventResult.create = function create(properties) {
            return new SpawnEntityToolEventResult(properties);
        };
    
        /**
         * Encodes the specified SpawnEntityToolEventResult message. Does not implicitly {@link SpawnEntityToolEventResult.verify|verify} messages.
         * @function encode
         * @memberof SpawnEntityToolEventResult
         * @static
         * @param {ISpawnEntityToolEventResult} message SpawnEntityToolEventResult message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        SpawnEntityToolEventResult.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.ehandle != null && Object.hasOwnProperty.call(message, "ehandle"))
                writer.uint32(/* id 1, wireType 0 =*/8).int32(message.ehandle);
            return writer;
        };
    
        /**
         * Encodes the specified SpawnEntityToolEventResult message, length delimited. Does not implicitly {@link SpawnEntityToolEventResult.verify|verify} messages.
         * @function encodeDelimited
         * @memberof SpawnEntityToolEventResult
         * @static
         * @param {ISpawnEntityToolEventResult} message SpawnEntityToolEventResult message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        SpawnEntityToolEventResult.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
    
        /**
         * Decodes a SpawnEntityToolEventResult message from the specified reader or buffer.
         * @function decode
         * @memberof SpawnEntityToolEventResult
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {SpawnEntityToolEventResult} SpawnEntityToolEventResult
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        SpawnEntityToolEventResult.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.SpawnEntityToolEventResult();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        /**
         * Decodes a SpawnEntityToolEventResult message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof SpawnEntityToolEventResult
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        SpawnEntityToolEventResult.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a SpawnEntityToolEventResult message.
         * @function verify
         * @memberof SpawnEntityToolEventResult
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        SpawnEntityToolEventResult.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.ehandle != null && message.hasOwnProperty("ehandle"))
                if (!$util.isInteger(message.ehandle))
        ...
        /**
         * Creates a SpawnEntityToolEventResult message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof SpawnEntityToolEventResult
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {SpawnEntityToolEventResult} SpawnEntityToolEventResult
         */
        SpawnEntityToolEventResult.fromObject = function fromObject(object) {
            if (object instanceof $root.SpawnEntityToolEventResult)
                return object;
            var message = new $root.SpawnEntityToolEventResult();
            if (object.ehandle != null)
                message.ehandle = object.ehandle | 0;
            return message;
        };
        ...
        /**
         * Creates a plain object from a SpawnEntityToolEventResult message. Also converts values to other types if specified.
         * @function toObject
         * @memberof SpawnEntityToolEventResult
         * @static
         * @param {SpawnEntityToolEventResult} message SpawnEntityToolEventResult
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        SpawnEntityToolEventResult.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults)
        ...
        /**
         * Converts this SpawnEntityToolEventResult to JSON.
         * @function toJSON
         * @memberof SpawnEntityToolEventResult
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        SpawnEntityToolEventResult.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    $root.DestroyEntityToolEvent = (function() {
    
        /**
         * Properties of a DestroyEntityToolEvent.
         * @exports IDestroyEntityToolEvent
         * @interface IDestroyEntityToolEvent
         * @property {number|null} [ehandle] DestroyEntityToolEvent ehandle
         */
    
        /**
         * Constructs a new DestroyEntityToolEvent.
         * @exports DestroyEntityToolEvent
         * @classdesc Represents a DestroyEntityToolEvent.
         * @implements IDestroyEntityToolEvent
         * @constructor
         * @param {IDestroyEntityToolEvent=} [properties] Properties to set
         */
        function DestroyEntityToolEvent(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
        ...
        /**
         * DestroyEntityToolEvent ehandle.
         * @member {number} ehandle
         * @memberof DestroyEntityToolEvent
         * @instance
         */
        DestroyEntityToolEvent.prototype.ehandle = 0;
    
        /**
         * Creates a new DestroyEntityToolEvent instance using the specified properties.
         * @function create
         * @memberof DestroyEntityToolEvent
         * @static
         * @param {IDestroyEntityToolEvent=} [properties] Properties to set
         * @returns {DestroyEntityToolEvent} DestroyEntityToolEvent instance
         */
        DestroyEntityToolEvent.create = function create(properties) {
            return new DestroyEntityToolEvent(properties);
        };
    
        /**
         * Encodes the specified DestroyEntityToolEvent message. Does not implicitly {@link DestroyEntityToolEvent.verify|verify} messages.
         * @function encode
         * @memberof DestroyEntityToolEvent
         * @static
         * @param {IDestroyEntityToolEvent} message DestroyEntityToolEvent message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        DestroyEntityToolEvent.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.ehandle != null && Object.hasOwnProperty.call(message, "ehandle"))
                writer.uint32(/* id 1, wireType 0 =*/8).int32(message.ehandle);
        ...
        /**
         * Encodes the specified DestroyEntityToolEvent message, length delimited. Does not implicitly {@link DestroyEntityToolEvent.verify|verify} messages.
         * @function encodeDelimited
         * @memberof DestroyEntityToolEvent
         * @static
         * @param {IDestroyEntityToolEvent} message DestroyEntityToolEvent message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        DestroyEntityToolEvent.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
    
        /**
         * Decodes a DestroyEntityToolEvent message from the specified reader or buffer.
         * @function decode
         * @memberof DestroyEntityToolEvent
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {DestroyEntityToolEvent} DestroyEntityToolEvent
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        DestroyEntityToolEvent.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.DestroyEntityToolEvent();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        /**
         * Decodes a DestroyEntityToolEvent message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof DestroyEntityToolEvent
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        DestroyEntityToolEvent.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a DestroyEntityToolEvent message.
         * @function verify
         * @memberof DestroyEntityToolEvent
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        DestroyEntityToolEvent.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.ehandle != null && message.hasOwnProperty("ehandle"))
                if (!$util.isInteger(message.ehandle))
        ...
        /**
         * Creates a DestroyEntityToolEvent message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof DestroyEntityToolEvent
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {DestroyEntityToolEvent} DestroyEntityToolEvent
         */
        DestroyEntityToolEvent.fromObject = function fromObject(object) {
            if (object instanceof $root.DestroyEntityToolEvent)
                return object;
            var message = new $root.DestroyEntityToolEvent();
            if (object.ehandle != null)
                message.ehandle = object.ehandle | 0;
            return message;
        };
        ...
        /**
         * Creates a plain object from a DestroyEntityToolEvent message. Also converts values to other types if specified.
         * @function toObject
         * @memberof DestroyEntityToolEvent
         * @static
         * @param {DestroyEntityToolEvent} message DestroyEntityToolEvent
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        DestroyEntityToolEvent.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults)
        ...
        /**
         * Converts this DestroyEntityToolEvent to JSON.
         * @function toJSON
         * @memberof DestroyEntityToolEvent
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        DestroyEntityToolEvent.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    $root.DestroyAllEntitiesToolEvent = (function() {
    
        /**
         * Properties of a DestroyAllEntitiesToolEvent.
         * @exports IDestroyAllEntitiesToolEvent
         * @interface IDestroyAllEntitiesToolEvent
         */
    
        /**
         * Constructs a new DestroyAllEntitiesToolEvent.
         * @exports DestroyAllEntitiesToolEvent
         * @classdesc Represents a DestroyAllEntitiesToolEvent.
         * @implements IDestroyAllEntitiesToolEvent
         * @constructor
         * @param {IDestroyAllEntitiesToolEvent=} [properties] Properties to set
         */
        function DestroyAllEntitiesToolEvent(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
        ...
        /**
         * Creates a new DestroyAllEntitiesToolEvent instance using the specified properties.
         * @function create
         * @memberof DestroyAllEntitiesToolEvent
         * @static
         * @param {IDestroyAllEntitiesToolEvent=} [properties] Properties to set
         * @returns {DestroyAllEntitiesToolEvent} DestroyAllEntitiesToolEvent instance
         */
        DestroyAllEntitiesToolEvent.create = function create(properties) {
            return new DestroyAllEntitiesToolEvent(properties);
        };
    
        /**
         * Encodes the specified DestroyAllEntitiesToolEvent message. Does not implicitly {@link DestroyAllEntitiesToolEvent.verify|verify} messages.
         * @function encode
         * @memberof DestroyAllEntitiesToolEvent
         * @static
         * @param {IDestroyAllEntitiesToolEvent} message DestroyAllEntitiesToolEvent message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        DestroyAllEntitiesToolEvent.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            return writer;
        };
        ...
        /**
         * Encodes the specified DestroyAllEntitiesToolEvent message, length delimited. Does not implicitly {@link DestroyAllEntitiesToolEvent.verify|verify} messages.
         * @function encodeDelimited
         * @memberof DestroyAllEntitiesToolEvent
         * @static
         * @param {IDestroyAllEntitiesToolEvent} message DestroyAllEntitiesToolEvent message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        DestroyAllEntitiesToolEvent.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
    
        /**
         * Decodes a DestroyAllEntitiesToolEvent message from the specified reader or buffer.
         * @function decode
         * @memberof DestroyAllEntitiesToolEvent
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {DestroyAllEntitiesToolEvent} DestroyAllEntitiesToolEvent
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        DestroyAllEntitiesToolEvent.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.DestroyAllEntitiesToolEvent();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                default:
        ...
        /**
         * Decodes a DestroyAllEntitiesToolEvent message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof DestroyAllEntitiesToolEvent
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        DestroyAllEntitiesToolEvent.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a DestroyAllEntitiesToolEvent message.
         * @function verify
         * @memberof DestroyAllEntitiesToolEvent
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        DestroyAllEntitiesToolEvent.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            return null;
        };
        ...
        /**
         * Creates a DestroyAllEntitiesToolEvent message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof DestroyAllEntitiesToolEvent
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {DestroyAllEntitiesToolEvent} DestroyAllEntitiesToolEvent
         */
        DestroyAllEntitiesToolEvent.fromObject = function fromObject(object) {
            if (object instanceof $root.DestroyAllEntitiesToolEvent)
                return object;
            return new $root.DestroyAllEntitiesToolEvent();
        };
    
        /**
         * Creates a plain object from a DestroyAllEntitiesToolEvent message. Also converts values to other types if specified.
         * @function toObject
         * @memberof DestroyAllEntitiesToolEvent
         * @static
         * @param {DestroyAllEntitiesToolEvent} message DestroyAllEntitiesToolEvent
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        DestroyAllEntitiesToolEvent.toObject = function toObject() {
            return {};
        };
    
        /**
         * Converts this DestroyAllEntitiesToolEvent to JSON.
         * @function toJSON
         * @memberof DestroyAllEntitiesToolEvent
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        DestroyAllEntitiesToolEvent.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    $root.RestartMapToolEvent = (function() {
    
        /**
         * Properties of a RestartMapToolEvent.
         * @exports IRestartMapToolEvent
         * @interface IRestartMapToolEvent
         */
    
        /**
         * Constructs a new RestartMapToolEvent.
         * @exports RestartMapToolEvent
         * @classdesc Represents a RestartMapToolEvent.
         * @implements IRestartMapToolEvent
         * @constructor
         * @param {IRestartMapToolEvent=} [properties] Properties to set
         */
        function RestartMapToolEvent(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
        ...
        /**
         * Creates a new RestartMapToolEvent instance using the specified properties.
         * @function create
         * @memberof RestartMapToolEvent
         * @static
         * @param {IRestartMapToolEvent=} [properties] Properties to set
         * @returns {RestartMapToolEvent} RestartMapToolEvent instance
         */
        RestartMapToolEvent.create = function create(properties) {
            return new RestartMapToolEvent(properties);
        };
    
        /**
         * Encodes the specified RestartMapToolEvent message. Does not implicitly {@link RestartMapToolEvent.verify|verify} messages.
         * @function encode
         * @memberof RestartMapToolEvent
         * @static
         * @param {IRestartMapToolEvent} message RestartMapToolEvent message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        RestartMapToolEvent.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            return writer;
        };
        ...
        /**
         * Encodes the specified RestartMapToolEvent message, length delimited. Does not implicitly {@link RestartMapToolEvent.verify|verify} messages.
         * @function encodeDelimited
         * @memberof RestartMapToolEvent
         * @static
         * @param {IRestartMapToolEvent} message RestartMapToolEvent message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        RestartMapToolEvent.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
    
        /**
         * Decodes a RestartMapToolEvent message from the specified reader or buffer.
         * @function decode
         * @memberof RestartMapToolEvent
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {RestartMapToolEvent} RestartMapToolEvent
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        RestartMapToolEvent.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.RestartMapToolEvent();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                default:
        ...
        /**
         * Decodes a RestartMapToolEvent message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof RestartMapToolEvent
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        RestartMapToolEvent.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a RestartMapToolEvent message.
         * @function verify
         * @memberof RestartMapToolEvent
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        RestartMapToolEvent.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            return null;
        };
        ...
        /**
         * Creates a RestartMapToolEvent message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof RestartMapToolEvent
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {RestartMapToolEvent} RestartMapToolEvent
         */
        RestartMapToolEvent.fromObject = function fromObject(object) {
            if (object instanceof $root.RestartMapToolEvent)
                return object;
            return new $root.RestartMapToolEvent();
        };
    
        /**
         * Creates a plain object from a RestartMapToolEvent message. Also converts values to other types if specified.
         * @function toObject
         * @memberof RestartMapToolEvent
         * @static
         * @param {RestartMapToolEvent} message RestartMapToolEvent
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        RestartMapToolEvent.toObject = function toObject() {
            return {};
        };
    
        /**
         * Converts this RestartMapToolEvent to JSON.
         * @function toJSON
         * @memberof RestartMapToolEvent
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        RestartMapToolEvent.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    $root.ToolEvent_GetEntityInfo = (function() {
    
        /**
         * Properties of a ToolEvent_GetEntityInfo.
         * @exports IToolEvent_GetEntityInfo
         * @interface IToolEvent_GetEntityInfo
         * @property {number|null} [ehandle] ToolEvent_GetEntityInfo ehandle
         * @property {boolean|null} [clientsideentity] ToolEvent_GetEntityInfo clientsideentity
         */
    
        /**
         * Constructs a new ToolEvent_GetEntityInfo.
         * @exports ToolEvent_GetEntityInfo
         * @classdesc Represents a ToolEvent_GetEntityInfo.
         * @implements IToolEvent_GetEntityInfo
         * @constructor
         * @param {IToolEvent_GetEntityInfo=} [properties] Properties to set
         */
        function ToolEvent_GetEntityInfo(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
        ...
        /**
         * ToolEvent_GetEntityInfo ehandle.
         * @member {number} ehandle
         * @memberof ToolEvent_GetEntityInfo
         * @instance
         */
        ToolEvent_GetEntityInfo.prototype.ehandle = 0;
    
        /**
         * ToolEvent_GetEntityInfo clientsideentity.
         * @member {boolean} clientsideentity
         * @memberof ToolEvent_GetEntityInfo
         * @instance
         */
        ToolEvent_GetEntityInfo.prototype.clientsideentity = false;
    
        /**
         * Creates a new ToolEvent_GetEntityInfo instance using the specified properties.
         * @function create
         * @memberof ToolEvent_GetEntityInfo
         * @static
         * @param {IToolEvent_GetEntityInfo=} [properties] Properties to set
         * @returns {ToolEvent_GetEntityInfo} ToolEvent_GetEntityInfo instance
         */
        ToolEvent_GetEntityInfo.create = function create(properties) {
            return new ToolEvent_GetEntityInfo(properties);
        };
    
        /**
         * Encodes the specified ToolEvent_GetEntityInfo message. Does not implicitly {@link ToolEvent_GetEntityInfo.verify|verify} messages.
         * @function encode
         * @memberof ToolEvent_GetEntityInfo
         * @static
         * @param {IToolEvent_GetEntityInfo} message ToolEvent_GetEntityInfo message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        ToolEvent_GetEntityInfo.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.ehandle != null && Object.hasOwnProperty.call(message, "ehandle"))
                writer.uint32(/* id 1, wireType 0 =*/8).int32(message.ehandle);
        ...
        /**
         * Encodes the specified ToolEvent_GetEntityInfo message, length delimited. Does not implicitly {@link ToolEvent_GetEntityInfo.verify|verify} messages.
         * @function encodeDelimited
         * @memberof ToolEvent_GetEntityInfo
         * @static
         * @param {IToolEvent_GetEntityInfo} message ToolEvent_GetEntityInfo message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        ToolEvent_GetEntityInfo.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
    
        /**
         * Decodes a ToolEvent_GetEntityInfo message from the specified reader or buffer.
         * @function decode
         * @memberof ToolEvent_GetEntityInfo
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {ToolEvent_GetEntityInfo} ToolEvent_GetEntityInfo
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ToolEvent_GetEntityInfo.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ToolEvent_GetEntityInfo();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        /**
         * Decodes a ToolEvent_GetEntityInfo message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof ToolEvent_GetEntityInfo
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ToolEvent_GetEntityInfo.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a ToolEvent_GetEntityInfo message.
         * @function verify
         * @memberof ToolEvent_GetEntityInfo
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        ToolEvent_GetEntityInfo.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.ehandle != null && message.hasOwnProperty("ehandle"))
                if (!$util.isInteger(message.ehandle))
        ...
        /**
         * Creates a ToolEvent_GetEntityInfo message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof ToolEvent_GetEntityInfo
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {ToolEvent_GetEntityInfo} ToolEvent_GetEntityInfo
         */
        ToolEvent_GetEntityInfo.fromObject = function fromObject(object) {
            if (object instanceof $root.ToolEvent_GetEntityInfo)
                return object;
            var message = new $root.ToolEvent_GetEntityInfo();
            if (object.ehandle != null)
                message.ehandle = object.ehandle | 0;
            if (object.clientsideentity != null)
                message.clientsideentity = Boolean(object.clientsideentity);
        ...
        /**
         * Creates a plain object from a ToolEvent_GetEntityInfo message. Also converts values to other types if specified.
         * @function toObject
         * @memberof ToolEvent_GetEntityInfo
         * @static
         * @param {ToolEvent_GetEntityInfo} message ToolEvent_GetEntityInfo
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        ToolEvent_GetEntityInfo.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
        ...
        /**
         * Converts this ToolEvent_GetEntityInfo to JSON.
         * @function toJSON
         * @memberof ToolEvent_GetEntityInfo
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        ToolEvent_GetEntityInfo.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    $root.ToolEvent_GetEntityInfoResult = (function() {
    
        /**
         * Properties of a ToolEvent_GetEntityInfoResult.
         * @exports IToolEvent_GetEntityInfoResult
         * @interface IToolEvent_GetEntityInfoResult
         * @property {string|null} [cppclass] ToolEvent_GetEntityInfoResult cppclass
         * @property {string|null} [classname] ToolEvent_GetEntityInfoResult classname
         * @property {string|null} [name] ToolEvent_GetEntityInfoResult name
         * @property {ICMsgVector|null} [origin] ToolEvent_GetEntityInfoResult origin
         * @property {ICMsgVector|null} [mins] ToolEvent_GetEntityInfoResult mins
         * @property {ICMsgVector|null} [maxs] ToolEvent_GetEntityInfoResult maxs
         */
    
        /**
         * Constructs a new ToolEvent_GetEntityInfoResult.
         * @exports ToolEvent_GetEntityInfoResult
         * @classdesc Represents a ToolEvent_GetEntityInfoResult.
         * @implements IToolEvent_GetEntityInfoResult
         * @constructor
         * @param {IToolEvent_GetEntityInfoResult=} [properties] Properties to set
         */
        function ToolEvent_GetEntityInfoResult(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
         ...
         * @member {string} cppclass
         * @memberof ToolEvent_GetEntityInfoResult
         * @instance
         */
        ToolEvent_GetEntityInfoResult.prototype.cppclass = "shithead";
         ...
         * @instance
         */
        ToolEvent_GetEntityInfoResult.prototype.classname = "";
         ...
         * @instance
         */
        ToolEvent_GetEntityInfoResult.prototype.name = "";
    
        /**
         * ToolEvent_GetEntityInfoResult origin.
         * @member {ICMsgVector|null|undefined} origin
         * @memberof ToolEvent_GetEntityInfoResult
         * @instance
         */
        ToolEvent_GetEntityInfoResult.prototype.origin = null;
    
        /**
         * ToolEvent_GetEntityInfoResult mins.
         * @member {ICMsgVector|null|undefined} mins
         * @memberof ToolEvent_GetEntityInfoResult
         * @instance
         */
        ToolEvent_GetEntityInfoResult.prototype.mins = null;
    
        /**
         * ToolEvent_GetEntityInfoResult maxs.
         * @member {ICMsgVector|null|undefined} maxs
         * @memberof ToolEvent_GetEntityInfoResult
         * @instance
         */
        ToolEvent_GetEntityInfoResult.prototype.maxs = null;
    
        /**
         * Creates a new ToolEvent_GetEntityInfoResult instance using the specified properties.
         * @function create
         * @memberof ToolEvent_GetEntityInfoResult
         * @static
         * @param {IToolEvent_GetEntityInfoResult=} [properties] Properties to set
         * @returns {ToolEvent_GetEntityInfoResult} ToolEvent_GetEntityInfoResult instance
         */
        ToolEvent_GetEntityInfoResult.create = function create(properties) {
            return new ToolEvent_GetEntityInfoResult(properties);
        };
    
        /**
         * Encodes the specified ToolEvent_GetEntityInfoResult message. Does not implicitly {@link ToolEvent_GetEntityInfoResult.verify|verify} messages.
         * @function encode
         * @memberof ToolEvent_GetEntityInfoResult
         * @static
         * @param {IToolEvent_GetEntityInfoResult} message ToolEvent_GetEntityInfoResult message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        ToolEvent_GetEntityInfoResult.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.cppclass != null && Object.hasOwnProperty.call(message, "cppclass"))
                writer.uint32(/* id 1, wireType 2 =*/10).string(message.cppclass);
            ...
            if (message.origin != null && Object.hasOwnProperty.call(message, "origin"))
                $root.CMsgVector.encode(message.origin, writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
            if (message.mins != null && Object.hasOwnProperty.call(message, "mins"))
                $root.CMsgVector.encode(message.mins, writer.uint32(/* id 5, wireType 2 =*/42).fork()).ldelim();
            if (message.maxs != null && Object.hasOwnProperty.call(message, "maxs"))
                $root.CMsgVector.encode(message.maxs, writer.uint32(/* id 6, wireType 2 =*/50).fork()).ldelim();
            return writer;
        };
    
        /**
         * Encodes the specified ToolEvent_GetEntityInfoResult message, length delimited. Does not implicitly {@link ToolEvent_GetEntityInfoResult.verify|verify} messages.
         * @function encodeDelimited
         * @memberof ToolEvent_GetEntityInfoResult
         * @static
         * @param {IToolEvent_GetEntityInfoResult} message ToolEvent_GetEntityInfoResult message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        ToolEvent_GetEntityInfoResult.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
    
        /**
         * Decodes a ToolEvent_GetEntityInfoResult message from the specified reader or buffer.
         * @function decode
         * @memberof ToolEvent_GetEntityInfoResult
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {ToolEvent_GetEntityInfoResult} ToolEvent_GetEntityInfoResult
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ToolEvent_GetEntityInfoResult.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ToolEvent_GetEntityInfoResult();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        /**
         * Decodes a ToolEvent_GetEntityInfoResult message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof ToolEvent_GetEntityInfoResult
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ToolEvent_GetEntityInfoResult.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a ToolEvent_GetEntityInfoResult message.
         * @function verify
         * @memberof ToolEvent_GetEntityInfoResult
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        ToolEvent_GetEntityInfoResult.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.cppclass != null && message.hasOwnProperty("cppclass"))
                if (!$util.isString(message.cppclass))
                    return "cppclass: string expected";
        ...
        /**
         * Creates a ToolEvent_GetEntityInfoResult message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof ToolEvent_GetEntityInfoResult
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {ToolEvent_GetEntityInfoResult} ToolEvent_GetEntityInfoResult
         */
        ToolEvent_GetEntityInfoResult.fromObject = function fromObject(object) {
            if (object instanceof $root.ToolEvent_GetEntityInfoResult)
                return object;
            var message = new $root.ToolEvent_GetEntityInfoResult();
            if (object.cppclass != null)
                message.cppclass = String(object.cppclass);
            ...
            if (object.origin != null) {
                if (typeof object.origin !== "object")
                    throw TypeError(".ToolEvent_GetEntityInfoResult.origin: object expected");
                message.origin = $root.CMsgVector.fromObject(object.origin);
            }
            if (object.mins != null) {
                if (typeof object.mins !== "object")
                    throw TypeError(".ToolEvent_GetEntityInfoResult.mins: object expected");
                message.mins = $root.CMsgVector.fromObject(object.mins);
            }
            if (object.maxs != null) {
                if (typeof object.maxs !== "object")
                    throw TypeError(".ToolEvent_GetEntityInfoResult.maxs: object expected");
        ...
        /**
         * Creates a plain object from a ToolEvent_GetEntityInfoResult message. Also converts values to other types if specified.
         * @function toObject
         * @memberof ToolEvent_GetEntityInfoResult
         * @static
         * @param {ToolEvent_GetEntityInfoResult} message ToolEvent_GetEntityInfoResult
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        ToolEvent_GetEntityInfoResult.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
                object.cppclass = "shithead";
                object.classname = "";
                object.name = "";
                object.origin = null;
                object.mins = null;
            ...
            if (message.cppclass != null && message.hasOwnProperty("cppclass"))
                object.cppclass = message.cppclass;
            if (message.classname != null && message.hasOwnProperty("classname"))
        ...
        /**
         * Converts this ToolEvent_GetEntityInfoResult to JSON.
         * @function toJSON
         * @memberof ToolEvent_GetEntityInfoResult
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        ToolEvent_GetEntityInfoResult.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    $root.ToolEvent_GetEntityInputs = (function() {
    
        /**
         * Properties of a ToolEvent_GetEntityInputs.
         * @exports IToolEvent_GetEntityInputs
         * @interface IToolEvent_GetEntityInputs
         * @property {number|null} [ehandle] ToolEvent_GetEntityInputs ehandle
         * @property {boolean|null} [clientsideentity] ToolEvent_GetEntityInputs clientsideentity
         */
    
        /**
         * Constructs a new ToolEvent_GetEntityInputs.
         * @exports ToolEvent_GetEntityInputs
         * @classdesc Represents a ToolEvent_GetEntityInputs.
         * @implements IToolEvent_GetEntityInputs
         * @constructor
         * @param {IToolEvent_GetEntityInputs=} [properties] Properties to set
         */
        function ToolEvent_GetEntityInputs(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
        ...
        /**
         * ToolEvent_GetEntityInputs ehandle.
         * @member {number} ehandle
         * @memberof ToolEvent_GetEntityInputs
         * @instance
         */
        ToolEvent_GetEntityInputs.prototype.ehandle = 0;
    
        /**
         * ToolEvent_GetEntityInputs clientsideentity.
         * @member {boolean} clientsideentity
         * @memberof ToolEvent_GetEntityInputs
         * @instance
         */
        ToolEvent_GetEntityInputs.prototype.clientsideentity = false;
    
        /**
         * Creates a new ToolEvent_GetEntityInputs instance using the specified properties.
         * @function create
         * @memberof ToolEvent_GetEntityInputs
         * @static
         * @param {IToolEvent_GetEntityInputs=} [properties] Properties to set
         * @returns {ToolEvent_GetEntityInputs} ToolEvent_GetEntityInputs instance
         */
        ToolEvent_GetEntityInputs.create = function create(properties) {
            return new ToolEvent_GetEntityInputs(properties);
        };
    
        /**
         * Encodes the specified ToolEvent_GetEntityInputs message. Does not implicitly {@link ToolEvent_GetEntityInputs.verify|verify} messages.
         * @function encode
         * @memberof ToolEvent_GetEntityInputs
         * @static
         * @param {IToolEvent_GetEntityInputs} message ToolEvent_GetEntityInputs message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        ToolEvent_GetEntityInputs.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.ehandle != null && Object.hasOwnProperty.call(message, "ehandle"))
                writer.uint32(/* id 1, wireType 0 =*/8).int32(message.ehandle);
        ...
        /**
         * Encodes the specified ToolEvent_GetEntityInputs message, length delimited. Does not implicitly {@link ToolEvent_GetEntityInputs.verify|verify} messages.
         * @function encodeDelimited
         * @memberof ToolEvent_GetEntityInputs
         * @static
         * @param {IToolEvent_GetEntityInputs} message ToolEvent_GetEntityInputs message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        ToolEvent_GetEntityInputs.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
    
        /**
         * Decodes a ToolEvent_GetEntityInputs message from the specified reader or buffer.
         * @function decode
         * @memberof ToolEvent_GetEntityInputs
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {ToolEvent_GetEntityInputs} ToolEvent_GetEntityInputs
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ToolEvent_GetEntityInputs.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ToolEvent_GetEntityInputs();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        /**
         * Decodes a ToolEvent_GetEntityInputs message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof ToolEvent_GetEntityInputs
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ToolEvent_GetEntityInputs.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a ToolEvent_GetEntityInputs message.
         * @function verify
         * @memberof ToolEvent_GetEntityInputs
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        ToolEvent_GetEntityInputs.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.ehandle != null && message.hasOwnProperty("ehandle"))
                if (!$util.isInteger(message.ehandle))
        ...
        /**
         * Creates a ToolEvent_GetEntityInputs message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof ToolEvent_GetEntityInputs
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {ToolEvent_GetEntityInputs} ToolEvent_GetEntityInputs
         */
        ToolEvent_GetEntityInputs.fromObject = function fromObject(object) {
            if (object instanceof $root.ToolEvent_GetEntityInputs)
                return object;
            var message = new $root.ToolEvent_GetEntityInputs();
            if (object.ehandle != null)
                message.ehandle = object.ehandle | 0;
            if (object.clientsideentity != null)
                message.clientsideentity = Boolean(object.clientsideentity);
        ...
        /**
         * Creates a plain object from a ToolEvent_GetEntityInputs message. Also converts values to other types if specified.
         * @function toObject
         * @memberof ToolEvent_GetEntityInputs
         * @static
         * @param {ToolEvent_GetEntityInputs} message ToolEvent_GetEntityInputs
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        ToolEvent_GetEntityInputs.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
        ...
        /**
         * Converts this ToolEvent_GetEntityInputs to JSON.
         * @function toJSON
         * @memberof ToolEvent_GetEntityInputs
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        ToolEvent_GetEntityInputs.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    $root.ToolEvent_GetEntityInputsResult = (function() {
    
        /**
         * Properties of a ToolEvent_GetEntityInputsResult.
         * @exports IToolEvent_GetEntityInputsResult
         * @interface IToolEvent_GetEntityInputsResult
         * @property {Array.<string>|null} [input_list] ToolEvent_GetEntityInputsResult input_list
         */
    
        /**
         * Constructs a new ToolEvent_GetEntityInputsResult.
         * @exports ToolEvent_GetEntityInputsResult
         * @classdesc Represents a ToolEvent_GetEntityInputsResult.
         * @implements IToolEvent_GetEntityInputsResult
         * @constructor
         * @param {IToolEvent_GetEntityInputsResult=} [properties] Properties to set
         */
        function ToolEvent_GetEntityInputsResult(properties) {
            this.input_list = [];
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
         ...
         * @member {Array.<string>} input_list
         * @memberof ToolEvent_GetEntityInputsResult
         * @instance
         */
        ToolEvent_GetEntityInputsResult.prototype.input_list = $util.emptyArray;
    
        /**
         * Creates a new ToolEvent_GetEntityInputsResult instance using the specified properties.
         * @function create
         * @memberof ToolEvent_GetEntityInputsResult
         * @static
         * @param {IToolEvent_GetEntityInputsResult=} [properties] Properties to set
         * @returns {ToolEvent_GetEntityInputsResult} ToolEvent_GetEntityInputsResult instance
         */
        ToolEvent_GetEntityInputsResult.create = function create(properties) {
            return new ToolEvent_GetEntityInputsResult(properties);
        };
    
        /**
         * Encodes the specified ToolEvent_GetEntityInputsResult message. Does not implicitly {@link ToolEvent_GetEntityInputsResult.verify|verify} messages.
         * @function encode
         * @memberof ToolEvent_GetEntityInputsResult
         * @static
         * @param {IToolEvent_GetEntityInputsResult} message ToolEvent_GetEntityInputsResult message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        ToolEvent_GetEntityInputsResult.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.input_list != null && message.input_list.length)
                for (var i = 0; i < message.input_list.length; ++i)
                    writer.uint32(/* id 1, wireType 2 =*/10).string(message.input_list[i]);
            return writer;
        };
    
        /**
         * Encodes the specified ToolEvent_GetEntityInputsResult message, length delimited. Does not implicitly {@link ToolEvent_GetEntityInputsResult.verify|verify} messages.
         * @function encodeDelimited
         * @memberof ToolEvent_GetEntityInputsResult
         * @static
         * @param {IToolEvent_GetEntityInputsResult} message ToolEvent_GetEntityInputsResult message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        ToolEvent_GetEntityInputsResult.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
    
        /**
         * Decodes a ToolEvent_GetEntityInputsResult message from the specified reader or buffer.
         * @function decode
         * @memberof ToolEvent_GetEntityInputsResult
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {ToolEvent_GetEntityInputsResult} ToolEvent_GetEntityInputsResult
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ToolEvent_GetEntityInputsResult.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ToolEvent_GetEntityInputsResult();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
                    if (!(message.input_list && message.input_list.length))
                        message.input_list = [];
                    message.input_list.push(reader.string());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
        ...
        /**
         * Decodes a ToolEvent_GetEntityInputsResult message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof ToolEvent_GetEntityInputsResult
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ToolEvent_GetEntityInputsResult.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a ToolEvent_GetEntityInputsResult message.
         * @function verify
         * @memberof ToolEvent_GetEntityInputsResult
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        ToolEvent_GetEntityInputsResult.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.input_list != null && message.hasOwnProperty("input_list")) {
                if (!Array.isArray(message.input_list))
                    return "input_list: array expected";
                for (var i = 0; i < message.input_list.length; ++i)
                    if (!$util.isString(message.input_list[i]))
                        return "input_list: string[] expected";
            }
            return null;
        };
    
        /**
         * Creates a ToolEvent_GetEntityInputsResult message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof ToolEvent_GetEntityInputsResult
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {ToolEvent_GetEntityInputsResult} ToolEvent_GetEntityInputsResult
         */
        ToolEvent_GetEntityInputsResult.fromObject = function fromObject(object) {
            if (object instanceof $root.ToolEvent_GetEntityInputsResult)
                return object;
            var message = new $root.ToolEvent_GetEntityInputsResult();
            if (object.input_list) {
                if (!Array.isArray(object.input_list))
                    throw TypeError(".ToolEvent_GetEntityInputsResult.input_list: array expected");
                message.input_list = [];
                for (var i = 0; i < object.input_list.length; ++i)
                    message.input_list[i] = String(object.input_list[i]);
            }
            return message;
        };
    
        /**
         * Creates a plain object from a ToolEvent_GetEntityInputsResult message. Also converts values to other types if specified.
         * @function toObject
         * @memberof ToolEvent_GetEntityInputsResult
         * @static
         * @param {ToolEvent_GetEntityInputsResult} message ToolEvent_GetEntityInputsResult
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        ToolEvent_GetEntityInputsResult.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            ...
            if (message.input_list && message.input_list.length) {
                object.input_list = [];
                for (var j = 0; j < message.input_list.length; ++j)
                    object.input_list[j] = message.input_list[j];
            }
            return object;
        };
    
        /**
         * Converts this ToolEvent_GetEntityInputsResult to JSON.
         * @function toJSON
         * @memberof ToolEvent_GetEntityInputsResult
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        ToolEvent_GetEntityInputsResult.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    $root.ToolEvent_FireEntityInput = (function() {
    
        /**
         * Properties of a ToolEvent_FireEntityInput.
         * @exports IToolEvent_FireEntityInput
         * @interface IToolEvent_FireEntityInput
         * @property {number|null} [ehandle] ToolEvent_FireEntityInput ehandle
         * @property {boolean|null} [clientsideentity] ToolEvent_FireEntityInput clientsideentity
         * @property {string|null} [input_name] ToolEvent_FireEntityInput input_name
         * @property {string|null} [input_param] ToolEvent_FireEntityInput input_param
         */
    
        /**
         * Constructs a new ToolEvent_FireEntityInput.
         * @exports ToolEvent_FireEntityInput
         * @classdesc Represents a ToolEvent_FireEntityInput.
         * @implements IToolEvent_FireEntityInput
         * @constructor
         * @param {IToolEvent_FireEntityInput=} [properties] Properties to set
         */
        function ToolEvent_FireEntityInput(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
        ...
        /**
         * ToolEvent_FireEntityInput ehandle.
         * @member {number} ehandle
         * @memberof ToolEvent_FireEntityInput
         * @instance
         */
        ToolEvent_FireEntityInput.prototype.ehandle = 0;
    
        /**
         * ToolEvent_FireEntityInput clientsideentity.
         * @member {boolean} clientsideentity
         * @memberof ToolEvent_FireEntityInput
         * @instance
         */
        ToolEvent_FireEntityInput.prototype.clientsideentity = false;
    
        /**
         * ToolEvent_FireEntityInput input_name.
         * @member {string} input_name
         * @memberof ToolEvent_FireEntityInput
         * @instance
         */
        ToolEvent_FireEntityInput.prototype.input_name = "";
    
        /**
         * ToolEvent_FireEntityInput input_param.
         * @member {string} input_param
         * @memberof ToolEvent_FireEntityInput
         * @instance
         */
        ToolEvent_FireEntityInput.prototype.input_param = "";
    
        /**
         * Creates a new ToolEvent_FireEntityInput instance using the specified properties.
         * @function create
         * @memberof ToolEvent_FireEntityInput
         * @static
         * @param {IToolEvent_FireEntityInput=} [properties] Properties to set
         * @returns {ToolEvent_FireEntityInput} ToolEvent_FireEntityInput instance
         */
        ToolEvent_FireEntityInput.create = function create(properties) {
            return new ToolEvent_FireEntityInput(properties);
        };
    
        /**
         * Encodes the specified ToolEvent_FireEntityInput message. Does not implicitly {@link ToolEvent_FireEntityInput.verify|verify} messages.
         * @function encode
         * @memberof ToolEvent_FireEntityInput
         * @static
         * @param {IToolEvent_FireEntityInput} message ToolEvent_FireEntityInput message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        ToolEvent_FireEntityInput.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.ehandle != null && Object.hasOwnProperty.call(message, "ehandle"))
                writer.uint32(/* id 1, wireType 0 =*/8).int32(message.ehandle);
            if (message.clientsideentity != null && Object.hasOwnProperty.call(message, "clientsideentity"))
                writer.uint32(/* id 2, wireType 0 =*/16).bool(message.clientsideentity);
            if (message.input_name != null && Object.hasOwnProperty.call(message, "input_name"))
                writer.uint32(/* id 3, wireType 2 =*/26).string(message.input_name);
            if (message.input_param != null && Object.hasOwnProperty.call(message, "input_param"))
                writer.uint32(/* id 4, wireType 2 =*/34).string(message.input_param);
            return writer;
        };
    
        /**
         * Encodes the specified ToolEvent_FireEntityInput message, length delimited. Does not implicitly {@link ToolEvent_FireEntityInput.verify|verify} messages.
         * @function encodeDelimited
         * @memberof ToolEvent_FireEntityInput
         * @static
         * @param {IToolEvent_FireEntityInput} message ToolEvent_FireEntityInput message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        ToolEvent_FireEntityInput.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
    
        /**
         * Decodes a ToolEvent_FireEntityInput message from the specified reader or buffer.
         * @function decode
         * @memberof ToolEvent_FireEntityInput
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {ToolEvent_FireEntityInput} ToolEvent_FireEntityInput
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ToolEvent_FireEntityInput.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ToolEvent_FireEntityInput();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
                ...
                case 3:
                    ...
                    break;
                case 4:
                    message.input_param = reader.string();
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
        ...
        /**
         * Decodes a ToolEvent_FireEntityInput message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof ToolEvent_FireEntityInput
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ToolEvent_FireEntityInput.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a ToolEvent_FireEntityInput message.
         * @function verify
         * @memberof ToolEvent_FireEntityInput
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        ToolEvent_FireEntityInput.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.ehandle != null && message.hasOwnProperty("ehandle"))
                if (!$util.isInteger(message.ehandle))
            ...
            if (message.clientsideentity != null && message.hasOwnProperty("clientsideentity"))
                if (typeof message.clientsideentity !== "boolean")
                    return "clientsideentity: boolean expected";
            if (message.input_name != null && message.hasOwnProperty("input_name"))
                if (!$util.isString(message.input_name))
                    return "input_name: string expected";
            if (message.input_param != null && message.hasOwnProperty("input_param"))
                if (!$util.isString(message.input_param))
                    return "input_param: string expected";
            return null;
        };
    
        /**
         * Creates a ToolEvent_FireEntityInput message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof ToolEvent_FireEntityInput
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {ToolEvent_FireEntityInput} ToolEvent_FireEntityInput
         */
        ToolEvent_FireEntityInput.fromObject = function fromObject(object) {
            if (object instanceof $root.ToolEvent_FireEntityInput)
                return object;
            var message = new $root.ToolEvent_FireEntityInput();
            if (object.ehandle != null)
                message.ehandle = object.ehandle | 0;
            if (object.clientsideentity != null)
                message.clientsideentity = Boolean(object.clientsideentity);
            if (object.input_name != null)
                message.input_name = String(object.input_name);
            if (object.input_param != null)
                message.input_param = String(object.input_param);
            return message;
        };
    
        /**
         * Creates a plain object from a ToolEvent_FireEntityInput message. Also converts values to other types if specified.
         * @function toObject
         * @memberof ToolEvent_FireEntityInput
         * @static
         * @param {ToolEvent_FireEntityInput} message ToolEvent_FireEntityInput
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        ToolEvent_FireEntityInput.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
            ...
            if (message.clientsideentity != null && message.hasOwnProperty("clientsideentity"))
                object.clientsideentity = message.clientsideentity;
            if (message.input_name != null && message.hasOwnProperty("input_name"))
                object.input_name = message.input_name;
            if (message.input_param != null && message.hasOwnProperty("input_param"))
                object.input_param = message.input_param;
            return object;
        };
    
        /**
         * Converts this ToolEvent_FireEntityInput to JSON.
         * @function toJSON
         * @memberof ToolEvent_FireEntityInput
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        ToolEvent_FireEntityInput.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    $root.ToolEvent_SFMRecordingStateChanged = (function() {
    
        /**
         * Properties of a ToolEvent_SFMRecordingStateChanged.
         * @exports IToolEvent_SFMRecordingStateChanged
         * @interface IToolEvent_SFMRecordingStateChanged
         * @property {boolean|null} [isrecording] ToolEvent_SFMRecordingStateChanged isrecording
         */
    
        /**
         * Constructs a new ToolEvent_SFMRecordingStateChanged.
         * @exports ToolEvent_SFMRecordingStateChanged
         * @classdesc Represents a ToolEvent_SFMRecordingStateChanged.
         * @implements IToolEvent_SFMRecordingStateChanged
         * @constructor
         * @param {IToolEvent_SFMRecordingStateChanged=} [properties] Properties to set
         */
        function ToolEvent_SFMRecordingStateChanged(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
        ...
        /**
         * ToolEvent_SFMRecordingStateChanged isrecording.
         * @member {boolean} isrecording
         * @memberof ToolEvent_SFMRecordingStateChanged
         * @instance
         */
        ToolEvent_SFMRecordingStateChanged.prototype.isrecording = false;
    
        /**
         * Creates a new ToolEvent_SFMRecordingStateChanged instance using the specified properties.
         * @function create
         * @memberof ToolEvent_SFMRecordingStateChanged
         * @static
         * @param {IToolEvent_SFMRecordingStateChanged=} [properties] Properties to set
         * @returns {ToolEvent_SFMRecordingStateChanged} ToolEvent_SFMRecordingStateChanged instance
         */
        ToolEvent_SFMRecordingStateChanged.create = function create(properties) {
            return new ToolEvent_SFMRecordingStateChanged(properties);
        };
    
        /**
         * Encodes the specified ToolEvent_SFMRecordingStateChanged message. Does not implicitly {@link ToolEvent_SFMRecordingStateChanged.verify|verify} messages.
         * @function encode
         * @memberof ToolEvent_SFMRecordingStateChanged
         * @static
         * @param {IToolEvent_SFMRecordingStateChanged} message ToolEvent_SFMRecordingStateChanged message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        ToolEvent_SFMRecordingStateChanged.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
        ...
        /**
         * Encodes the specified ToolEvent_SFMRecordingStateChanged message, length delimited. Does not implicitly {@link ToolEvent_SFMRecordingStateChanged.verify|verify} messages.
         * @function encodeDelimited
         * @memberof ToolEvent_SFMRecordingStateChanged
         * @static
         * @param {IToolEvent_SFMRecordingStateChanged} message ToolEvent_SFMRecordingStateChanged message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        ToolEvent_SFMRecordingStateChanged.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
    
        /**
         * Decodes a ToolEvent_SFMRecordingStateChanged message from the specified reader or buffer.
         * @function decode
         * @memberof ToolEvent_SFMRecordingStateChanged
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {ToolEvent_SFMRecordingStateChanged} ToolEvent_SFMRecordingStateChanged
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ToolEvent_SFMRecordingStateChanged.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ToolEvent_SFMRecordingStateChanged();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        /**
         * Decodes a ToolEvent_SFMRecordingStateChanged message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof ToolEvent_SFMRecordingStateChanged
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ToolEvent_SFMRecordingStateChanged.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a ToolEvent_SFMRecordingStateChanged message.
         * @function verify
         * @memberof ToolEvent_SFMRecordingStateChanged
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        ToolEvent_SFMRecordingStateChanged.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
        ...
        /**
         * Creates a ToolEvent_SFMRecordingStateChanged message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof ToolEvent_SFMRecordingStateChanged
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {ToolEvent_SFMRecordingStateChanged} ToolEvent_SFMRecordingStateChanged
         */
        ToolEvent_SFMRecordingStateChanged.fromObject = function fromObject(object) {
            if (object instanceof $root.ToolEvent_SFMRecordingStateChanged)
                return object;
            var message = new $root.ToolEvent_SFMRecordingStateChanged();
        ...
        /**
         * Creates a plain object from a ToolEvent_SFMRecordingStateChanged message. Also converts values to other types if specified.
         * @function toObject
         * @memberof ToolEvent_SFMRecordingStateChanged
         * @static
         * @param {ToolEvent_SFMRecordingStateChanged} message ToolEvent_SFMRecordingStateChanged
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        ToolEvent_SFMRecordingStateChanged.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults)
        ...
        /**
         * Converts this ToolEvent_SFMRecordingStateChanged to JSON.
         * @function toJSON
         * @memberof ToolEvent_SFMRecordingStateChanged
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        ToolEvent_SFMRecordingStateChanged.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    $root.ToolEvent_SFMToolActiveStateChanged = (function() {
    
        /**
         * Properties of a ToolEvent_SFMToolActiveStateChanged.
         * @exports IToolEvent_SFMToolActiveStateChanged
         * @interface IToolEvent_SFMToolActiveStateChanged
         * @property {boolean|null} [isactive] ToolEvent_SFMToolActiveStateChanged isactive
         */
    
        /**
         * Constructs a new ToolEvent_SFMToolActiveStateChanged.
         * @exports ToolEvent_SFMToolActiveStateChanged
         * @classdesc Represents a ToolEvent_SFMToolActiveStateChanged.
         * @implements IToolEvent_SFMToolActiveStateChanged
         * @constructor
         * @param {IToolEvent_SFMToolActiveStateChanged=} [properties] Properties to set
         */
        function ToolEvent_SFMToolActiveStateChanged(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
        ...
        /**
         * ToolEvent_SFMToolActiveStateChanged isactive.
         * @member {boolean} isactive
         * @memberof ToolEvent_SFMToolActiveStateChanged
         * @instance
         */
        ToolEvent_SFMToolActiveStateChanged.prototype.isactive = false;
    
        /**
         * Creates a new ToolEvent_SFMToolActiveStateChanged instance using the specified properties.
         * @function create
         * @memberof ToolEvent_SFMToolActiveStateChanged
         * @static
         * @param {IToolEvent_SFMToolActiveStateChanged=} [properties] Properties to set
         * @returns {ToolEvent_SFMToolActiveStateChanged} ToolEvent_SFMToolActiveStateChanged instance
         */
        ToolEvent_SFMToolActiveStateChanged.create = function create(properties) {
            return new ToolEvent_SFMToolActiveStateChanged(properties);
        };
    
        /**
         * Encodes the specified ToolEvent_SFMToolActiveStateChanged message. Does not implicitly {@link ToolEvent_SFMToolActiveStateChanged.verify|verify} messages.
         * @function encode
         * @memberof ToolEvent_SFMToolActiveStateChanged
         * @static
         * @param {IToolEvent_SFMToolActiveStateChanged} message ToolEvent_SFMToolActiveStateChanged message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        ToolEvent_SFMToolActiveStateChanged.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
        ...
        /**
         * Encodes the specified ToolEvent_SFMToolActiveStateChanged message, length delimited. Does not implicitly {@link ToolEvent_SFMToolActiveStateChanged.verify|verify} messages.
         * @function encodeDelimited
         * @memberof ToolEvent_SFMToolActiveStateChanged
         * @static
         * @param {IToolEvent_SFMToolActiveStateChanged} message ToolEvent_SFMToolActiveStateChanged message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        ToolEvent_SFMToolActiveStateChanged.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
    
        /**
         * Decodes a ToolEvent_SFMToolActiveStateChanged message from the specified reader or buffer.
         * @function decode
         * @memberof ToolEvent_SFMToolActiveStateChanged
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {ToolEvent_SFMToolActiveStateChanged} ToolEvent_SFMToolActiveStateChanged
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ToolEvent_SFMToolActiveStateChanged.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ToolEvent_SFMToolActiveStateChanged();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        /**
         * Decodes a ToolEvent_SFMToolActiveStateChanged message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof ToolEvent_SFMToolActiveStateChanged
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ToolEvent_SFMToolActiveStateChanged.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a ToolEvent_SFMToolActiveStateChanged message.
         * @function verify
         * @memberof ToolEvent_SFMToolActiveStateChanged
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        ToolEvent_SFMToolActiveStateChanged.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
        ...
        /**
         * Creates a ToolEvent_SFMToolActiveStateChanged message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof ToolEvent_SFMToolActiveStateChanged
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {ToolEvent_SFMToolActiveStateChanged} ToolEvent_SFMToolActiveStateChanged
         */
        ToolEvent_SFMToolActiveStateChanged.fromObject = function fromObject(object) {
            if (object instanceof $root.ToolEvent_SFMToolActiveStateChanged)
                return object;
            var message = new $root.ToolEvent_SFMToolActiveStateChanged();
        ...
        /**
         * Creates a plain object from a ToolEvent_SFMToolActiveStateChanged message. Also converts values to other types if specified.
         * @function toObject
         * @memberof ToolEvent_SFMToolActiveStateChanged
         * @static
         * @param {ToolEvent_SFMToolActiveStateChanged} message ToolEvent_SFMToolActiveStateChanged
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        ToolEvent_SFMToolActiveStateChanged.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults)
        ...
        /**
         * Converts this ToolEvent_SFMToolActiveStateChanged to JSON.
         * @function toJSON
         * @memberof ToolEvent_SFMToolActiveStateChanged
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        ToolEvent_SFMToolActiveStateChanged.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
