...
(function(global, factory) { /* global define, require, module */
     ...
     * @property {number} GE_ClearDecalsForSkeletonInstanceEvent=204 GE_ClearDecalsForSkeletonInstanceEvent value
    ...
    $root.EBaseGameEvents = (function() {
        ...
        values[valuesById[204] = "GE_ClearDecalsForSkeletonInstanceEvent"] = 204;
    ...
    $root.CMsgVDebugGameSessionIDEvent = (function() {
         ...
         */
        CMsgVDebugGameSessionIDEvent.decode = function decode(reader, length) {
    ...
    $root.CMsgPlaceDecalEvent = (function() {
         ...
         * @property {number|null} [decalmaterialindex] CMsgPlaceDecalEvent decalmaterialindex
         * @property {number|null} [flags] CMsgPlaceDecalEvent flags
         * @property {number|null} [color] CMsgPlaceDecalEvent color
         * @property {number|null} [width] CMsgPlaceDecalEvent width
         * @property {number|null} [height] CMsgPlaceDecalEvent height
         * @property {number|null} [depth] CMsgPlaceDecalEvent depth
         * @property {number|null} [entityhandleindex] CMsgPlaceDecalEvent entityhandleindex
         * @property {number|null} [skeletoninstancehash] CMsgPlaceDecalEvent skeletoninstancehash
         * @property {number|null} [boneindex] CMsgPlaceDecalEvent boneindex
         * @property {boolean|null} [translucenthit] CMsgPlaceDecalEvent translucenthit
         * @property {boolean|null} [is_adjacent] CMsgPlaceDecalEvent is_adjacent
         */
        ...
        /**
         * CMsgPlaceDecalEvent decalmaterialindex.
         * @member {number} decalmaterialindex
         * @memberof CMsgPlaceDecalEvent
         * @instance
         */
        CMsgPlaceDecalEvent.prototype.decalmaterialindex = 0;
        ...
        /**
         * CMsgPlaceDecalEvent width.
         * @member {number} width
         * @memberof CMsgPlaceDecalEvent
         * @instance
         */
        CMsgPlaceDecalEvent.prototype.width = 0;
    
        /**
         * CMsgPlaceDecalEvent height.
         * @member {number} height
         * @memberof CMsgPlaceDecalEvent
         * @instance
         */
        CMsgPlaceDecalEvent.prototype.height = 0;
    
        /**
         * CMsgPlaceDecalEvent depth.
         * @member {number} depth
         * @memberof CMsgPlaceDecalEvent
         * @instance
         */
        CMsgPlaceDecalEvent.prototype.depth = 0;
    
        /**
         * CMsgPlaceDecalEvent entityhandleindex.
         * @member {number} entityhandleindex
         * @memberof CMsgPlaceDecalEvent
         * @instance
         */
        CMsgPlaceDecalEvent.prototype.entityhandleindex = 0;
    
        /**
         * CMsgPlaceDecalEvent skeletoninstancehash.
         * @member {number} skeletoninstancehash
         * @memberof CMsgPlaceDecalEvent
         * @instance
         */
        CMsgPlaceDecalEvent.prototype.skeletoninstancehash = 0;
        ...
        /**
         * CMsgPlaceDecalEvent translucenthit.
         * @member {boolean} translucenthit
         * @memberof CMsgPlaceDecalEvent
         * @instance
         */
        CMsgPlaceDecalEvent.prototype.translucenthit = false;
    
        /**
         * CMsgPlaceDecalEvent is_adjacent.
         * @member {boolean} is_adjacent
         * @memberof CMsgPlaceDecalEvent
         * @instance
         */
        CMsgPlaceDecalEvent.prototype.is_adjacent = false;
        ...
        CMsgPlaceDecalEvent.encode = function encode(message, writer) {
            ...
            if (message.decalmaterialindex != null && Object.hasOwnProperty.call(message, "decalmaterialindex"))
                writer.uint32(/* id 4, wireType 0 =*/32).uint32(message.decalmaterialindex);
            ...
            if (message.depth != null && Object.hasOwnProperty.call(message, "depth"))
                writer.uint32(/* id 9, wireType 5 =*/77).float(message.depth);
            if (message.entityhandleindex != null && Object.hasOwnProperty.call(message, "entityhandleindex"))
                writer.uint32(/* id 10, wireType 0 =*/80).uint32(message.entityhandleindex);
            if (message.skeletoninstancehash != null && Object.hasOwnProperty.call(message, "skeletoninstancehash"))
                writer.uint32(/* id 11, wireType 5 =*/93).fixed32(message.skeletoninstancehash);
            if (message.boneindex != null && Object.hasOwnProperty.call(message, "boneindex"))
                writer.uint32(/* id 12, wireType 0 =*/96).int32(message.boneindex);
            if (message.translucenthit != null && Object.hasOwnProperty.call(message, "translucenthit"))
                writer.uint32(/* id 13, wireType 0 =*/104).bool(message.translucenthit);
            if (message.is_adjacent != null && Object.hasOwnProperty.call(message, "is_adjacent"))
                writer.uint32(/* id 14, wireType 0 =*/112).bool(message.is_adjacent);
            return writer;
        };
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CMsgPlaceDecalEvent.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
        ...
        CMsgPlaceDecalEvent.verify = function verify(message) {
            ...
            if (message.decalmaterialindex != null && message.hasOwnProperty("decalmaterialindex"))
                if (!$util.isInteger(message.decalmaterialindex))
                    return "decalmaterialindex: integer expected";
            ...
            if (message.entityhandleindex != null && message.hasOwnProperty("entityhandleindex"))
                if (!$util.isInteger(message.entityhandleindex))
                    return "entityhandleindex: integer expected";
            if (message.skeletoninstancehash != null && message.hasOwnProperty("skeletoninstancehash"))
                if (!$util.isInteger(message.skeletoninstancehash))
                    return "skeletoninstancehash: integer expected";
            ...
            if (message.translucenthit != null && message.hasOwnProperty("translucenthit"))
                if (typeof message.translucenthit !== "boolean")
                    return "translucenthit: boolean expected";
            if (message.is_adjacent != null && message.hasOwnProperty("is_adjacent"))
                if (typeof message.is_adjacent !== "boolean")
                    return "is_adjacent: boolean expected";
            return null;
        };
        ...
        CMsgPlaceDecalEvent.fromObject = function fromObject(object) {
            ...
            if (object.decalmaterialindex != null)
            ...
            if (object.entityhandleindex != null)
                message.entityhandleindex = object.entityhandleindex >>> 0;
            if (object.skeletoninstancehash != null)
                message.skeletoninstancehash = object.skeletoninstancehash >>> 0;
            if (object.boneindex != null)
                message.boneindex = object.boneindex | 0;
            if (object.translucenthit != null)
                message.translucenthit = Boolean(object.translucenthit);
            if (object.is_adjacent != null)
                message.is_adjacent = Boolean(object.is_adjacent);
            return message;
        };
        ...
        CMsgPlaceDecalEvent.toObject = function toObject(message, options) {
            ...
            if (options.defaults) {
                ...
                object.normal = null;
                object.saxis = null;
                object.decalmaterialindex = 0;
                object.flags = 0;
                object.color = 0;
                object.width = 0;
                object.height = 0;
                object.depth = 0;
                object.entityhandleindex = 0;
                object.skeletoninstancehash = 0;
                object.boneindex = 0;
                object.translucenthit = false;
                object.is_adjacent = false;
            }
            if (message.position != null && message.hasOwnProperty("position"))
            ...
            if (message.decalmaterialindex != null && message.hasOwnProperty("decalmaterialindex"))
                object.decalmaterialindex = message.decalmaterialindex;
            if (message.flags != null && message.hasOwnProperty("flags"))
            ...
            if (message.entityhandleindex != null && message.hasOwnProperty("entityhandleindex"))
                object.entityhandleindex = message.entityhandleindex;
            if (message.skeletoninstancehash != null && message.hasOwnProperty("skeletoninstancehash"))
                object.skeletoninstancehash = message.skeletoninstancehash;
            if (message.boneindex != null && message.hasOwnProperty("boneindex"))
                object.boneindex = message.boneindex;
            if (message.translucenthit != null && message.hasOwnProperty("translucenthit"))
                object.translucenthit = message.translucenthit;
            if (message.is_adjacent != null && message.hasOwnProperty("is_adjacent"))
                object.is_adjacent = message.is_adjacent;
            return object;
        };
    ...
    $root.CMsgClearWorldDecalsEvent = (function() {
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CMsgClearWorldDecalsEvent.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
    ...
    $root.CMsgClearEntityDecalsEvent = (function() {
        ...
        /**
         * Decodes a CMsgClearEntityDecalsEvent message from the specified reader or buffer.
         * @function decode
         * @memberof CMsgClearEntityDecalsEvent
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CMsgClearEntityDecalsEvent.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
        ...
        /**
         * Decodes a CMsgClearEntityDecalsEvent message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof CMsgClearEntityDecalsEvent
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CMsgClearEntityDecalsEvent.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a CMsgClearEntityDecalsEvent message.
         * @function verify
         * @memberof CMsgClearEntityDecalsEvent
         * @static
         * @param {Object.<string,*>} message Plain object to verify
        ...
        /**
         * Creates a CMsgClearEntityDecalsEvent message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof CMsgClearEntityDecalsEvent
         * @static
         * @param {Object.<string,*>} object Plain object
        ...
        /**
         * Creates a plain object from a CMsgClearEntityDecalsEvent message. Also converts values to other types if specified.
         * @function toObject
         * @memberof CMsgClearEntityDecalsEvent
         * @static
         * @param {CMsgClearEntityDecalsEvent} message CMsgClearEntityDecalsEvent
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        ...
        /**
         * Converts this CMsgClearEntityDecalsEvent to JSON.
         * @function toJSON
         * @memberof CMsgClearEntityDecalsEvent
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        CMsgClearEntityDecalsEvent.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    $root.CMsgClearDecalsForSkeletonInstanceEvent = (function() {
    
        /**
         * Properties of a CMsgClearDecalsForSkeletonInstanceEvent.
         * @exports ICMsgClearDecalsForSkeletonInstanceEvent
         * @interface ICMsgClearDecalsForSkeletonInstanceEvent
         * @property {number|null} [flagstoclear] CMsgClearDecalsForSkeletonInstanceEvent flagstoclear
         * @property {number|null} [entityhandleindex] CMsgClearDecalsForSkeletonInstanceEvent entityhandleindex
         * @property {number|null} [skeletoninstancehash] CMsgClearDecalsForSkeletonInstanceEvent skeletoninstancehash
         */
    
        /**
         * Constructs a new CMsgClearDecalsForSkeletonInstanceEvent.
         * @exports CMsgClearDecalsForSkeletonInstanceEvent
         * @classdesc Represents a CMsgClearDecalsForSkeletonInstanceEvent.
         * @implements ICMsgClearDecalsForSkeletonInstanceEvent
         * @constructor
         * @param {ICMsgClearDecalsForSkeletonInstanceEvent=} [properties] Properties to set
         */
        function CMsgClearDecalsForSkeletonInstanceEvent(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
        ...
        /**
         * CMsgClearDecalsForSkeletonInstanceEvent flagstoclear.
         * @member {number} flagstoclear
         * @memberof CMsgClearDecalsForSkeletonInstanceEvent
         * @instance
         */
        CMsgClearDecalsForSkeletonInstanceEvent.prototype.flagstoclear = 0;
    
        /**
         * CMsgClearDecalsForSkeletonInstanceEvent entityhandleindex.
         * @member {number} entityhandleindex
         * @memberof CMsgClearDecalsForSkeletonInstanceEvent
         * @instance
         */
        CMsgClearDecalsForSkeletonInstanceEvent.prototype.entityhandleindex = 0;
    
        /**
         * CMsgClearDecalsForSkeletonInstanceEvent skeletoninstancehash.
         * @member {number} skeletoninstancehash
         * @memberof CMsgClearDecalsForSkeletonInstanceEvent
         * @instance
         */
        CMsgClearDecalsForSkeletonInstanceEvent.prototype.skeletoninstancehash = 0;
    
        /**
         * Creates a new CMsgClearDecalsForSkeletonInstanceEvent instance using the specified properties.
         * @function create
         * @memberof CMsgClearDecalsForSkeletonInstanceEvent
         * @static
         * @param {ICMsgClearDecalsForSkeletonInstanceEvent=} [properties] Properties to set
         * @returns {CMsgClearDecalsForSkeletonInstanceEvent} CMsgClearDecalsForSkeletonInstanceEvent instance
         */
        CMsgClearDecalsForSkeletonInstanceEvent.create = function create(properties) {
            return new CMsgClearDecalsForSkeletonInstanceEvent(properties);
        };
    
        /**
         * Encodes the specified CMsgClearDecalsForSkeletonInstanceEvent message. Does not implicitly {@link CMsgClearDecalsForSkeletonInstanceEvent.verify|verify} messages.
         * @function encode
         * @memberof CMsgClearDecalsForSkeletonInstanceEvent
         * @static
         * @param {ICMsgClearDecalsForSkeletonInstanceEvent} message CMsgClearDecalsForSkeletonInstanceEvent message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        CMsgClearDecalsForSkeletonInstanceEvent.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.flagstoclear != null && Object.hasOwnProperty.call(message, "flagstoclear"))
                writer.uint32(/* id 1, wireType 0 =*/8).uint32(message.flagstoclear);
            if (message.entityhandleindex != null && Object.hasOwnProperty.call(message, "entityhandleindex"))
                writer.uint32(/* id 2, wireType 0 =*/16).uint32(message.entityhandleindex);
            if (message.skeletoninstancehash != null && Object.hasOwnProperty.call(message, "skeletoninstancehash"))
                writer.uint32(/* id 3, wireType 0 =*/24).uint32(message.skeletoninstancehash);
            return writer;
        };
    
        /**
         * Encodes the specified CMsgClearDecalsForSkeletonInstanceEvent message, length delimited. Does not implicitly {@link CMsgClearDecalsForSkeletonInstanceEvent.verify|verify} messages.
         * @function encodeDelimited
         * @memberof CMsgClearDecalsForSkeletonInstanceEvent
         * @static
         * @param {ICMsgClearDecalsForSkeletonInstanceEvent} message CMsgClearDecalsForSkeletonInstanceEvent message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        CMsgClearDecalsForSkeletonInstanceEvent.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
    
        /**
         * Decodes a CMsgClearDecalsForSkeletonInstanceEvent message from the specified reader or buffer.
         * @function decode
         * @memberof CMsgClearDecalsForSkeletonInstanceEvent
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {CMsgClearDecalsForSkeletonInstanceEvent} CMsgClearDecalsForSkeletonInstanceEvent
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CMsgClearDecalsForSkeletonInstanceEvent.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.CMsgClearDecalsForSkeletonInstanceEvent();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        /**
         * Decodes a CMsgClearDecalsForSkeletonInstanceEvent message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof CMsgClearDecalsForSkeletonInstanceEvent
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CMsgClearDecalsForSkeletonInstanceEvent.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a CMsgClearDecalsForSkeletonInstanceEvent message.
         * @function verify
         * @memberof CMsgClearDecalsForSkeletonInstanceEvent
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        CMsgClearDecalsForSkeletonInstanceEvent.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.flagstoclear != null && message.hasOwnProperty("flagstoclear"))
                if (!$util.isInteger(message.flagstoclear))
        ...
        /**
         * Creates a CMsgClearDecalsForSkeletonInstanceEvent message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof CMsgClearDecalsForSkeletonInstanceEvent
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {CMsgClearDecalsForSkeletonInstanceEvent} CMsgClearDecalsForSkeletonInstanceEvent
         */
        CMsgClearDecalsForSkeletonInstanceEvent.fromObject = function fromObject(object) {
            if (object instanceof $root.CMsgClearDecalsForSkeletonInstanceEvent)
                return object;
            var message = new $root.CMsgClearDecalsForSkeletonInstanceEvent();
            if (object.flagstoclear != null)
                message.flagstoclear = object.flagstoclear >>> 0;
            if (object.entityhandleindex != null)
                message.entityhandleindex = object.entityhandleindex >>> 0;
        ...
        /**
         * Creates a plain object from a CMsgClearDecalsForSkeletonInstanceEvent message. Also converts values to other types if specified.
         * @function toObject
         * @memberof CMsgClearDecalsForSkeletonInstanceEvent
         * @static
         * @param {CMsgClearDecalsForSkeletonInstanceEvent} message CMsgClearDecalsForSkeletonInstanceEvent
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        CMsgClearDecalsForSkeletonInstanceEvent.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
        ...
        /**
         * Converts this CMsgClearDecalsForSkeletonInstanceEvent to JSON.
         * @function toJSON
         * @memberof CMsgClearDecalsForSkeletonInstanceEvent
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        CMsgClearDecalsForSkeletonInstanceEvent.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    $root.CMsgSource1LegacyGameEventList = (function() {
    
        /**
         * Properties of a CMsgSource1LegacyGameEventList.
         * @exports ICMsgSource1LegacyGameEventList
         * @interface ICMsgSource1LegacyGameEventList
         * @property {Array.<CMsgSource1LegacyGameEventList.Idescriptor_t>|null} [descriptors] CMsgSource1LegacyGameEventList descriptors
         */
    
        /**
         * Constructs a new CMsgSource1LegacyGameEventList.
         * @exports CMsgSource1LegacyGameEventList
         * @classdesc Represents a CMsgSource1LegacyGameEventList.
         * @implements ICMsgSource1LegacyGameEventList
         * @constructor
         * @param {ICMsgSource1LegacyGameEventList=} [properties] Properties to set
         */
        function CMsgSource1LegacyGameEventList(properties) {
            this.descriptors = [];
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
        ...
        /**
         * CMsgSource1LegacyGameEventList descriptors.
         * @member {Array.<CMsgSource1LegacyGameEventList.Idescriptor_t>} descriptors
         * @memberof CMsgSource1LegacyGameEventList
         * @instance
         */
        CMsgSource1LegacyGameEventList.prototype.descriptors = $util.emptyArray;
    
        /**
         * Creates a new CMsgSource1LegacyGameEventList instance using the specified properties.
         * @function create
         * @memberof CMsgSource1LegacyGameEventList
         * @static
         * @param {ICMsgSource1LegacyGameEventList=} [properties] Properties to set
         * @returns {CMsgSource1LegacyGameEventList} CMsgSource1LegacyGameEventList instance
         */
        CMsgSource1LegacyGameEventList.create = function create(properties) {
            return new CMsgSource1LegacyGameEventList(properties);
        };
    
        /**
         * Encodes the specified CMsgSource1LegacyGameEventList message. Does not implicitly {@link CMsgSource1LegacyGameEventList.verify|verify} messages.
         * @function encode
         * @memberof CMsgSource1LegacyGameEventList
         * @static
         * @param {ICMsgSource1LegacyGameEventList} message CMsgSource1LegacyGameEventList message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        ...
        /**
         * Encodes the specified CMsgSource1LegacyGameEventList message, length delimited. Does not implicitly {@link CMsgSource1LegacyGameEventList.verify|verify} messages.
         * @function encodeDelimited
         * @memberof CMsgSource1LegacyGameEventList
         * @static
         * @param {ICMsgSource1LegacyGameEventList} message CMsgSource1LegacyGameEventList message or plain object to encode
        ...
        /**
         * Decodes a CMsgSource1LegacyGameEventList message from the specified reader or buffer.
         * @function decode
         * @memberof CMsgSource1LegacyGameEventList
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CMsgSource1LegacyGameEventList.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
        ...
        /**
         * Decodes a CMsgSource1LegacyGameEventList message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof CMsgSource1LegacyGameEventList
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CMsgSource1LegacyGameEventList.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a CMsgSource1LegacyGameEventList message.
         * @function verify
         * @memberof CMsgSource1LegacyGameEventList
         * @static
         * @param {Object.<string,*>} message Plain object to verify
        ...
        /**
         * Creates a CMsgSource1LegacyGameEventList message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof CMsgSource1LegacyGameEventList
         * @static
         * @param {Object.<string,*>} object Plain object
        ...
        /**
         * Creates a plain object from a CMsgSource1LegacyGameEventList message. Also converts values to other types if specified.
         * @function toObject
         * @memberof CMsgSource1LegacyGameEventList
         * @static
         * @param {CMsgSource1LegacyGameEventList} message CMsgSource1LegacyGameEventList
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        ...
        /**
         * Converts this CMsgSource1LegacyGameEventList to JSON.
         * @function toJSON
         * @memberof CMsgSource1LegacyGameEventList
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        CMsgSource1LegacyGameEventList.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    
        CMsgSource1LegacyGameEventList.key_t = (function() {
             ...
             * @implements Ikey_t
             * @constructor
             * @param {CMsgSource1LegacyGameEventList.Ikey_t=} [properties] Properties to set
             */
             ...
             * key_t type.
             * @member {number} type
             * @memberof CMsgSource1LegacyGameEventList.key_t
             * @instance
             */
             ...
             * @static
             * @param {CMsgSource1LegacyGameEventList.Ikey_t=} [properties] Properties to set
             * @returns {CMsgSource1LegacyGameEventList.key_t} key_t instance
             */
            ...
            /**
             * Encodes the specified key_t message. Does not implicitly {@link CMsgSource1LegacyGameEventList.key_t.verify|verify} messages.
             * @function encode
             * @memberof CMsgSource1LegacyGameEventList.key_t
             * @static
             * @param {CMsgSource1LegacyGameEventList.Ikey_t} message key_t message or plain object to encode
             * @param {$protobuf.Writer} [writer] Writer to encode to
             * @returns {$protobuf.Writer} Writer
             */
            ...
            /**
             * Encodes the specified key_t message, length delimited. Does not implicitly {@link CMsgSource1LegacyGameEventList.key_t.verify|verify} messages.
             * @function encodeDelimited
             * @memberof CMsgSource1LegacyGameEventList.key_t
             * @static
             * @param {CMsgSource1LegacyGameEventList.Ikey_t} message key_t message or plain object to encode
             ...
             * @memberof CMsgSource1LegacyGameEventList.key_t
             * @static
             * @param {CMsgSource1LegacyGameEventList.key_t} message key_t
             * @param {$protobuf.IConversionOptions} [options] Conversion options
             * @returns {Object.<string,*>} Plain object
             */
        ...
        CMsgSource1LegacyGameEventList.descriptor_t = (function() {
             ...
             * @property {Array.<CMsgSource1LegacyGameEventList.Ikey_t>|null} [keys] descriptor_t keys
             */
             ...
             * @constructor
             * @param {CMsgSource1LegacyGameEventList.Idescriptor_t=} [properties] Properties to set
             */
             ...
             * @memberof CMsgSource1LegacyGameEventList.descriptor_t
             * @instance
             */
            ...
            /**
             * descriptor_t keys.
             * @member {Array.<CMsgSource1LegacyGameEventList.Ikey_t>} keys
             * @memberof CMsgSource1LegacyGameEventList.descriptor_t
             * @instance
             */
             ...
             * @static
             * @param {CMsgSource1LegacyGameEventList.Idescriptor_t=} [properties] Properties to set
             * @returns {CMsgSource1LegacyGameEventList.descriptor_t} descriptor_t instance
             */
            ...
            /**
             * Encodes the specified descriptor_t message. Does not implicitly {@link CMsgSource1LegacyGameEventList.descriptor_t.verify|verify} messages.
             * @function encode
             * @memberof CMsgSource1LegacyGameEventList.descriptor_t
             * @static
             * @param {CMsgSource1LegacyGameEventList.Idescriptor_t} message descriptor_t message or plain object to encode
             * @param {$protobuf.Writer} [writer] Writer to encode to
             * @returns {$protobuf.Writer} Writer
             */
            ...
            /**
             * Encodes the specified descriptor_t message, length delimited. Does not implicitly {@link CMsgSource1LegacyGameEventList.descriptor_t.verify|verify} messages.
             * @function encodeDelimited
             * @memberof CMsgSource1LegacyGameEventList.descriptor_t
             * @static
             * @param {CMsgSource1LegacyGameEventList.Idescriptor_t} message descriptor_t message or plain object to encode
             ...
             * @memberof CMsgSource1LegacyGameEventList.descriptor_t
             * @static
             * @param {CMsgSource1LegacyGameEventList.descriptor_t} message descriptor_t
             * @param {$protobuf.IConversionOptions} [options] Conversion options
             * @returns {Object.<string,*>} Plain object
             */
    ...
    $root.CMsgSource1LegacyListenEvents = (function() {
    
        /**
         * Properties of a CMsgSource1LegacyListenEvents.
         * @exports ICMsgSource1LegacyListenEvents
         * @interface ICMsgSource1LegacyListenEvents
         * @property {number|null} [playerslot] CMsgSource1LegacyListenEvents playerslot
         * @property {Array.<number>|null} [eventarraybits] CMsgSource1LegacyListenEvents eventarraybits
         */
    
        /**
         * Constructs a new CMsgSource1LegacyListenEvents.
         * @exports CMsgSource1LegacyListenEvents
         * @classdesc Represents a CMsgSource1LegacyListenEvents.
         * @implements ICMsgSource1LegacyListenEvents
         * @constructor
         * @param {ICMsgSource1LegacyListenEvents=} [properties] Properties to set
         */
        function CMsgSource1LegacyListenEvents(properties) {
            this.eventarraybits = [];
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
        ...
        /**
         * CMsgSource1LegacyListenEvents playerslot.
         * @member {number} playerslot
         * @memberof CMsgSource1LegacyListenEvents
         * @instance
         */
        CMsgSource1LegacyListenEvents.prototype.playerslot = 0;
    
        /**
         * CMsgSource1LegacyListenEvents eventarraybits.
         * @member {Array.<number>} eventarraybits
         * @memberof CMsgSource1LegacyListenEvents
         * @instance
         */
        CMsgSource1LegacyListenEvents.prototype.eventarraybits = $util.emptyArray;
    
        /**
         * Creates a new CMsgSource1LegacyListenEvents instance using the specified properties.
         * @function create
         * @memberof CMsgSource1LegacyListenEvents
         * @static
         * @param {ICMsgSource1LegacyListenEvents=} [properties] Properties to set
         * @returns {CMsgSource1LegacyListenEvents} CMsgSource1LegacyListenEvents instance
         */
        CMsgSource1LegacyListenEvents.create = function create(properties) {
            return new CMsgSource1LegacyListenEvents(properties);
        };
    
        /**
         * Encodes the specified CMsgSource1LegacyListenEvents message. Does not implicitly {@link CMsgSource1LegacyListenEvents.verify|verify} messages.
         * @function encode
         * @memberof CMsgSource1LegacyListenEvents
         * @static
         * @param {ICMsgSource1LegacyListenEvents} message CMsgSource1LegacyListenEvents message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        CMsgSource1LegacyListenEvents.encode = function encode(message, writer) {
            ...
            if (message.eventarraybits != null && message.eventarraybits.length)
                for (var i = 0; i < message.eventarraybits.length; ++i)
                    writer.uint32(/* id 2, wireType 0 =*/16).uint32(message.eventarraybits[i]);
            return writer;
        };
    
        /**
         * Encodes the specified CMsgSource1LegacyListenEvents message, length delimited. Does not implicitly {@link CMsgSource1LegacyListenEvents.verify|verify} messages.
         * @function encodeDelimited
         * @memberof CMsgSource1LegacyListenEvents
         * @static
         * @param {ICMsgSource1LegacyListenEvents} message CMsgSource1LegacyListenEvents message or plain object to encode
        ...
        /**
         * Decodes a CMsgSource1LegacyListenEvents message from the specified reader or buffer.
         * @function decode
         * @memberof CMsgSource1LegacyListenEvents
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CMsgSource1LegacyListenEvents.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
        ...
        /**
         * Decodes a CMsgSource1LegacyListenEvents message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof CMsgSource1LegacyListenEvents
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CMsgSource1LegacyListenEvents.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a CMsgSource1LegacyListenEvents message.
         * @function verify
         * @memberof CMsgSource1LegacyListenEvents
         * @static
         * @param {Object.<string,*>} message Plain object to verify
        ...
        CMsgSource1LegacyListenEvents.verify = function verify(message) {
            ...
            if (message.eventarraybits != null && message.hasOwnProperty("eventarraybits")) {
                ...
                for (var i = 0; i < message.eventarraybits.length; ++i)
                    if (!$util.isInteger(message.eventarraybits[i]))
                        return "eventarraybits: integer[] expected";
            }
            return null;
        };
    
        /**
         * Creates a CMsgSource1LegacyListenEvents message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof CMsgSource1LegacyListenEvents
         * @static
         * @param {Object.<string,*>} object Plain object
        ...
        CMsgSource1LegacyListenEvents.fromObject = function fromObject(object) {
            ...
            if (object.eventarraybits) {
                if (!Array.isArray(object.eventarraybits))
                    throw TypeError(".CMsgSource1LegacyListenEvents.eventarraybits: array expected");
                message.eventarraybits = [];
                for (var i = 0; i < object.eventarraybits.length; ++i)
                    message.eventarraybits[i] = object.eventarraybits[i] >>> 0;
            }
            return message;
        };
    
        /**
         * Creates a plain object from a CMsgSource1LegacyListenEvents message. Also converts values to other types if specified.
         * @function toObject
         * @memberof CMsgSource1LegacyListenEvents
         * @static
         * @param {CMsgSource1LegacyListenEvents} message CMsgSource1LegacyListenEvents
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        CMsgSource1LegacyListenEvents.toObject = function toObject(message, options) {
            ...
            if (message.eventarraybits && message.eventarraybits.length) {
                object.eventarraybits = [];
                for (var j = 0; j < message.eventarraybits.length; ++j)
                    object.eventarraybits[j] = message.eventarraybits[j];
            }
            return object;
        };
    
        /**
         * Converts this CMsgSource1LegacyListenEvents to JSON.
         * @function toJSON
         * @memberof CMsgSource1LegacyListenEvents
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        CMsgSource1LegacyListenEvents.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    $root.CMsgSource1LegacyGameEvent = (function() {
    
        /**
         * Properties of a CMsgSource1LegacyGameEvent.
         * @exports ICMsgSource1LegacyGameEvent
         * @interface ICMsgSource1LegacyGameEvent
         * @property {string|null} [event_name] CMsgSource1LegacyGameEvent event_name
         * @property {number|null} [eventid] CMsgSource1LegacyGameEvent eventid
         * @property {Array.<CMsgSource1LegacyGameEvent.Ikey_t>|null} [keys] CMsgSource1LegacyGameEvent keys
         */
    
        /**
         * Constructs a new CMsgSource1LegacyGameEvent.
         * @exports CMsgSource1LegacyGameEvent
         * @classdesc Represents a CMsgSource1LegacyGameEvent.
         * @implements ICMsgSource1LegacyGameEvent
         * @constructor
         * @param {ICMsgSource1LegacyGameEvent=} [properties] Properties to set
         */
        function CMsgSource1LegacyGameEvent(properties) {
            this.keys = [];
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
         ...
         * @memberof CMsgSource1LegacyGameEvent
         * @instance
         */
        CMsgSource1LegacyGameEvent.prototype.event_name = "";
    
        /**
         * CMsgSource1LegacyGameEvent eventid.
         * @member {number} eventid
         * @memberof CMsgSource1LegacyGameEvent
         * @instance
         */
        CMsgSource1LegacyGameEvent.prototype.eventid = 0;
    
        /**
         * CMsgSource1LegacyGameEvent keys.
         * @member {Array.<CMsgSource1LegacyGameEvent.Ikey_t>} keys
         * @memberof CMsgSource1LegacyGameEvent
         * @instance
         */
        CMsgSource1LegacyGameEvent.prototype.keys = $util.emptyArray;
    
        /**
         * Creates a new CMsgSource1LegacyGameEvent instance using the specified properties.
         * @function create
         * @memberof CMsgSource1LegacyGameEvent
         * @static
         * @param {ICMsgSource1LegacyGameEvent=} [properties] Properties to set
         * @returns {CMsgSource1LegacyGameEvent} CMsgSource1LegacyGameEvent instance
         */
        CMsgSource1LegacyGameEvent.create = function create(properties) {
            return new CMsgSource1LegacyGameEvent(properties);
        };
    
        /**
         * Encodes the specified CMsgSource1LegacyGameEvent message. Does not implicitly {@link CMsgSource1LegacyGameEvent.verify|verify} messages.
         * @function encode
         * @memberof CMsgSource1LegacyGameEvent
         * @static
         * @param {ICMsgSource1LegacyGameEvent} message CMsgSource1LegacyGameEvent message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        ...
        /**
         * Encodes the specified CMsgSource1LegacyGameEvent message, length delimited. Does not implicitly {@link CMsgSource1LegacyGameEvent.verify|verify} messages.
         * @function encodeDelimited
         * @memberof CMsgSource1LegacyGameEvent
         * @static
         * @param {ICMsgSource1LegacyGameEvent} message CMsgSource1LegacyGameEvent message or plain object to encode
        ...
        /**
         * Decodes a CMsgSource1LegacyGameEvent message from the specified reader or buffer.
         * @function decode
         * @memberof CMsgSource1LegacyGameEvent
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CMsgSource1LegacyGameEvent.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
        ...
        /**
         * Decodes a CMsgSource1LegacyGameEvent message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof CMsgSource1LegacyGameEvent
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CMsgSource1LegacyGameEvent.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a CMsgSource1LegacyGameEvent message.
         * @function verify
         * @memberof CMsgSource1LegacyGameEvent
         * @static
         * @param {Object.<string,*>} message Plain object to verify
        ...
        /**
         * Creates a CMsgSource1LegacyGameEvent message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof CMsgSource1LegacyGameEvent
         * @static
         * @param {Object.<string,*>} object Plain object
        ...
        /**
         * Creates a plain object from a CMsgSource1LegacyGameEvent message. Also converts values to other types if specified.
         * @function toObject
         * @memberof CMsgSource1LegacyGameEvent
         * @static
         * @param {CMsgSource1LegacyGameEvent} message CMsgSource1LegacyGameEvent
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        ...
        /**
         * Converts this CMsgSource1LegacyGameEvent to JSON.
         * @function toJSON
         * @memberof CMsgSource1LegacyGameEvent
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        CMsgSource1LegacyGameEvent.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    
        CMsgSource1LegacyGameEvent.key_t = (function() {
             ...
             * @implements Ikey_t
             * @constructor
             * @param {CMsgSource1LegacyGameEvent.Ikey_t=} [properties] Properties to set
             */
            function key_t(properties) {
                if (properties)
                    for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
             ...
             * key_t type.
             * @member {number} type
             * @memberof CMsgSource1LegacyGameEvent.key_t
             * @instance
             */
            key_t.prototype.type = 0;
             ...
             * @static
             * @param {CMsgSource1LegacyGameEvent.Ikey_t=} [properties] Properties to set
             * @returns {CMsgSource1LegacyGameEvent.key_t} key_t instance
             */
            key_t.create = function create(properties) {
                return new key_t(properties);
            };
            ...
            /**
             * Encodes the specified key_t message. Does not implicitly {@link CMsgSource1LegacyGameEvent.key_t.verify|verify} messages.
             * @function encode
             * @memberof CMsgSource1LegacyGameEvent.key_t
             * @static
             * @param {CMsgSource1LegacyGameEvent.Ikey_t} message key_t message or plain object to encode
             * @param {$protobuf.Writer} [writer] Writer to encode to
             * @returns {$protobuf.Writer} Writer
             */
            key_t.encode = function encode(message, writer) {
            ...
            /**
             * Encodes the specified key_t message, length delimited. Does not implicitly {@link CMsgSource1LegacyGameEvent.key_t.verify|verify} messages.
             * @function encodeDelimited
             * @memberof CMsgSource1LegacyGameEvent.key_t
             * @static
             * @param {CMsgSource1LegacyGameEvent.Ikey_t} message key_t message or plain object to encode
             ...
             * @memberof CMsgSource1LegacyGameEvent.key_t
             * @static
             * @param {CMsgSource1LegacyGameEvent.key_t} message key_t
             * @param {$protobuf.IConversionOptions} [options] Conversion options
             * @returns {Object.<string,*>} Plain object
             */
            key_t.toObject = function toObject(message, options) {
    ...
    $root.CMsgSosStartSoundEvent = (function() {
    
        /**
         * Properties of a CMsgSosStartSoundEvent.
         * @exports ICMsgSosStartSoundEvent
         * @interface ICMsgSosStartSoundEvent
         * @property {number|null} [soundevent_guid] CMsgSosStartSoundEvent soundevent_guid
         * @property {number|null} [soundevent_hash] CMsgSosStartSoundEvent soundevent_hash
         * @property {number|null} [source_entity_index] CMsgSosStartSoundEvent source_entity_index
         * @property {number|null} [seed] CMsgSosStartSoundEvent seed
         * @property {Uint8Array|null} [packed_params] CMsgSosStartSoundEvent packed_params
         * @property {number|null} [start_time] CMsgSosStartSoundEvent start_time
         */
    
        /**
         * Constructs a new CMsgSosStartSoundEvent.
         * @exports CMsgSosStartSoundEvent
         * @classdesc Represents a CMsgSosStartSoundEvent.
         * @implements ICMsgSosStartSoundEvent
         * @constructor
         * @param {ICMsgSosStartSoundEvent=} [properties] Properties to set
         */
        ...
        /**
         * CMsgSosStartSoundEvent soundevent_guid.
         * @member {number} soundevent_guid
         * @memberof CMsgSosStartSoundEvent
         * @instance
         */
        CMsgSosStartSoundEvent.prototype.soundevent_guid = 0;
    
        /**
         * CMsgSosStartSoundEvent soundevent_hash.
         * @member {number} soundevent_hash
         * @memberof CMsgSosStartSoundEvent
         * @instance
         */
        CMsgSosStartSoundEvent.prototype.soundevent_hash = 0;
    
        /**
         * CMsgSosStartSoundEvent source_entity_index.
         * @member {number} source_entity_index
         * @memberof CMsgSosStartSoundEvent
         * @instance
         */
        CMsgSosStartSoundEvent.prototype.source_entity_index = 0;
    
        /**
         * CMsgSosStartSoundEvent seed.
         * @member {number} seed
         * @memberof CMsgSosStartSoundEvent
         * @instance
         */
        CMsgSosStartSoundEvent.prototype.seed = 0;
    
        /**
         * CMsgSosStartSoundEvent packed_params.
         * @member {Uint8Array} packed_params
         * @memberof CMsgSosStartSoundEvent
         * @instance
         */
        CMsgSosStartSoundEvent.prototype.packed_params = $util.newBuffer([]);
    
        /**
         * CMsgSosStartSoundEvent start_time.
         * @member {number} start_time
         * @memberof CMsgSosStartSoundEvent
         * @instance
         */
        CMsgSosStartSoundEvent.prototype.start_time = 0;
    
        /**
         * Creates a new CMsgSosStartSoundEvent instance using the specified properties.
         * @function create
         * @memberof CMsgSosStartSoundEvent
         * @static
         * @param {ICMsgSosStartSoundEvent=} [properties] Properties to set
         * @returns {CMsgSosStartSoundEvent} CMsgSosStartSoundEvent instance
         */
        CMsgSosStartSoundEvent.create = function create(properties) {
            return new CMsgSosStartSoundEvent(properties);
        };
    
        /**
         * Encodes the specified CMsgSosStartSoundEvent message. Does not implicitly {@link CMsgSosStartSoundEvent.verify|verify} messages.
         * @function encode
         * @memberof CMsgSosStartSoundEvent
         * @static
         * @param {ICMsgSosStartSoundEvent} message CMsgSosStartSoundEvent message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        CMsgSosStartSoundEvent.encode = function encode(message, writer) {
            ...
            if (message.soundevent_hash != null && Object.hasOwnProperty.call(message, "soundevent_hash"))
                writer.uint32(/* id 2, wireType 5 =*/21).fixed32(message.soundevent_hash);
            if (message.source_entity_index != null && Object.hasOwnProperty.call(message, "source_entity_index"))
                writer.uint32(/* id 3, wireType 0 =*/24).int32(message.source_entity_index);
            ...
            if (message.packed_params != null && Object.hasOwnProperty.call(message, "packed_params"))
                writer.uint32(/* id 5, wireType 2 =*/42).bytes(message.packed_params);
            if (message.start_time != null && Object.hasOwnProperty.call(message, "start_time"))
                writer.uint32(/* id 6, wireType 5 =*/53).float(message.start_time);
            return writer;
        };
    
        /**
         * Encodes the specified CMsgSosStartSoundEvent message, length delimited. Does not implicitly {@link CMsgSosStartSoundEvent.verify|verify} messages.
         * @function encodeDelimited
         * @memberof CMsgSosStartSoundEvent
         * @static
         * @param {ICMsgSosStartSoundEvent} message CMsgSosStartSoundEvent message or plain object to encode
        ...
        /**
         * Decodes a CMsgSosStartSoundEvent message from the specified reader or buffer.
         * @function decode
         * @memberof CMsgSosStartSoundEvent
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CMsgSosStartSoundEvent.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
        ...
        /**
         * Decodes a CMsgSosStartSoundEvent message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof CMsgSosStartSoundEvent
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CMsgSosStartSoundEvent.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a CMsgSosStartSoundEvent message.
         * @function verify
         * @memberof CMsgSosStartSoundEvent
         * @static
         * @param {Object.<string,*>} message Plain object to verify
        ...
        /**
         * Creates a CMsgSosStartSoundEvent message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof CMsgSosStartSoundEvent
         * @static
         * @param {Object.<string,*>} object Plain object
        ...
        CMsgSosStartSoundEvent.fromObject = function fromObject(object) {
            ...
            if (object.packed_params != null)
                if (typeof object.packed_params === "string")
                    $util.base64.decode(object.packed_params, message.packed_params = $util.newBuffer($util.base64.length(object.packed_params)), 0);
                else if (object.packed_params.length)
                    message.packed_params = object.packed_params;
        ...
        /**
         * Creates a plain object from a CMsgSosStartSoundEvent message. Also converts values to other types if specified.
         * @function toObject
         * @memberof CMsgSosStartSoundEvent
         * @static
         * @param {CMsgSosStartSoundEvent} message CMsgSosStartSoundEvent
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        CMsgSosStartSoundEvent.toObject = function toObject(message, options) {
            ...
            if (options.defaults) {
                ...
                object.source_entity_index = 0;
                object.seed = 0;
                if (options.bytes === String)
                    object.packed_params = "";
                else {
                    object.packed_params = [];
        ...
        /**
         * Converts this CMsgSosStartSoundEvent to JSON.
         * @function toJSON
         * @memberof CMsgSosStartSoundEvent
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        CMsgSosStartSoundEvent.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    $root.CMsgSosStopSoundEvent = (function() {
    
        /**
         * Properties of a CMsgSosStopSoundEvent.
         * @exports ICMsgSosStopSoundEvent
         * @interface ICMsgSosStopSoundEvent
         * @property {number|null} [soundevent_guid] CMsgSosStopSoundEvent soundevent_guid
         */
    
        /**
         * Constructs a new CMsgSosStopSoundEvent.
         * @exports CMsgSosStopSoundEvent
         * @classdesc Represents a CMsgSosStopSoundEvent.
         * @implements ICMsgSosStopSoundEvent
         * @constructor
         * @param {ICMsgSosStopSoundEvent=} [properties] Properties to set
         */
        ...
        /**
         * CMsgSosStopSoundEvent soundevent_guid.
         * @member {number} soundevent_guid
         * @memberof CMsgSosStopSoundEvent
         * @instance
         */
        CMsgSosStopSoundEvent.prototype.soundevent_guid = 0;
    
        /**
         * Creates a new CMsgSosStopSoundEvent instance using the specified properties.
         * @function create
         * @memberof CMsgSosStopSoundEvent
         * @static
         * @param {ICMsgSosStopSoundEvent=} [properties] Properties to set
         * @returns {CMsgSosStopSoundEvent} CMsgSosStopSoundEvent instance
         */
        CMsgSosStopSoundEvent.create = function create(properties) {
            return new CMsgSosStopSoundEvent(properties);
        };
    
        /**
         * Encodes the specified CMsgSosStopSoundEvent message. Does not implicitly {@link CMsgSosStopSoundEvent.verify|verify} messages.
         * @function encode
         * @memberof CMsgSosStopSoundEvent
         * @static
         * @param {ICMsgSosStopSoundEvent} message CMsgSosStopSoundEvent message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        ...
        /**
         * Encodes the specified CMsgSosStopSoundEvent message, length delimited. Does not implicitly {@link CMsgSosStopSoundEvent.verify|verify} messages.
         * @function encodeDelimited
         * @memberof CMsgSosStopSoundEvent
         * @static
         * @param {ICMsgSosStopSoundEvent} message CMsgSosStopSoundEvent message or plain object to encode
        ...
        /**
         * Decodes a CMsgSosStopSoundEvent message from the specified reader or buffer.
         * @function decode
         * @memberof CMsgSosStopSoundEvent
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CMsgSosStopSoundEvent.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
        ...
        /**
         * Decodes a CMsgSosStopSoundEvent message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof CMsgSosStopSoundEvent
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CMsgSosStopSoundEvent.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a CMsgSosStopSoundEvent message.
         * @function verify
         * @memberof CMsgSosStopSoundEvent
         * @static
         * @param {Object.<string,*>} message Plain object to verify
        ...
        /**
         * Creates a CMsgSosStopSoundEvent message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof CMsgSosStopSoundEvent
         * @static
         * @param {Object.<string,*>} object Plain object
        ...
        /**
         * Creates a plain object from a CMsgSosStopSoundEvent message. Also converts values to other types if specified.
         * @function toObject
         * @memberof CMsgSosStopSoundEvent
         * @static
         * @param {CMsgSosStopSoundEvent} message CMsgSosStopSoundEvent
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        ...
        /**
         * Converts this CMsgSosStopSoundEvent to JSON.
         * @function toJSON
         * @memberof CMsgSosStopSoundEvent
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        CMsgSosStopSoundEvent.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    $root.CMsgSosStopSoundEventHash = (function() {
    
        /**
         * Properties of a CMsgSosStopSoundEventHash.
         * @exports ICMsgSosStopSoundEventHash
         * @interface ICMsgSosStopSoundEventHash
         * @property {number|null} [soundevent_hash] CMsgSosStopSoundEventHash soundevent_hash
         * @property {number|null} [source_entity_index] CMsgSosStopSoundEventHash source_entity_index
         */
    
        /**
         * Constructs a new CMsgSosStopSoundEventHash.
         * @exports CMsgSosStopSoundEventHash
         * @classdesc Represents a CMsgSosStopSoundEventHash.
         * @implements ICMsgSosStopSoundEventHash
         * @constructor
         * @param {ICMsgSosStopSoundEventHash=} [properties] Properties to set
         */
        ...
        /**
         * CMsgSosStopSoundEventHash soundevent_hash.
         * @member {number} soundevent_hash
         * @memberof CMsgSosStopSoundEventHash
         * @instance
         */
        CMsgSosStopSoundEventHash.prototype.soundevent_hash = 0;
    
        /**
         * CMsgSosStopSoundEventHash source_entity_index.
         * @member {number} source_entity_index
         * @memberof CMsgSosStopSoundEventHash
         * @instance
         */
        CMsgSosStopSoundEventHash.prototype.source_entity_index = 0;
    
        /**
         * Creates a new CMsgSosStopSoundEventHash instance using the specified properties.
         * @function create
         * @memberof CMsgSosStopSoundEventHash
         * @static
         * @param {ICMsgSosStopSoundEventHash=} [properties] Properties to set
         * @returns {CMsgSosStopSoundEventHash} CMsgSosStopSoundEventHash instance
         */
        CMsgSosStopSoundEventHash.create = function create(properties) {
            return new CMsgSosStopSoundEventHash(properties);
        };
    
        /**
         * Encodes the specified CMsgSosStopSoundEventHash message. Does not implicitly {@link CMsgSosStopSoundEventHash.verify|verify} messages.
         * @function encode
         * @memberof CMsgSosStopSoundEventHash
         * @static
         * @param {ICMsgSosStopSoundEventHash} message CMsgSosStopSoundEventHash message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        CMsgSosStopSoundEventHash.encode = function encode(message, writer) {
            ...
            if (message.source_entity_index != null && Object.hasOwnProperty.call(message, "source_entity_index"))
                writer.uint32(/* id 2, wireType 0 =*/16).int32(message.source_entity_index);
            return writer;
        };
    
        /**
         * Encodes the specified CMsgSosStopSoundEventHash message, length delimited. Does not implicitly {@link CMsgSosStopSoundEventHash.verify|verify} messages.
         * @function encodeDelimited
         * @memberof CMsgSosStopSoundEventHash
         * @static
         * @param {ICMsgSosStopSoundEventHash} message CMsgSosStopSoundEventHash message or plain object to encode
        ...
        /**
         * Decodes a CMsgSosStopSoundEventHash message from the specified reader or buffer.
         * @function decode
         * @memberof CMsgSosStopSoundEventHash
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CMsgSosStopSoundEventHash.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
        ...
        /**
         * Decodes a CMsgSosStopSoundEventHash message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof CMsgSosStopSoundEventHash
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CMsgSosStopSoundEventHash.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a CMsgSosStopSoundEventHash message.
         * @function verify
         * @memberof CMsgSosStopSoundEventHash
         * @static
         * @param {Object.<string,*>} message Plain object to verify
        ...
        /**
         * Creates a CMsgSosStopSoundEventHash message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof CMsgSosStopSoundEventHash
         * @static
         * @param {Object.<string,*>} object Plain object
        ...
        /**
         * Creates a plain object from a CMsgSosStopSoundEventHash message. Also converts values to other types if specified.
         * @function toObject
         * @memberof CMsgSosStopSoundEventHash
         * @static
         * @param {CMsgSosStopSoundEventHash} message CMsgSosStopSoundEventHash
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        ...
        /**
         * Converts this CMsgSosStopSoundEventHash to JSON.
         * @function toJSON
         * @memberof CMsgSosStopSoundEventHash
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        CMsgSosStopSoundEventHash.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    $root.CMsgSosSetSoundEventParams = (function() {
    
        /**
         * Properties of a CMsgSosSetSoundEventParams.
         * @exports ICMsgSosSetSoundEventParams
         * @interface ICMsgSosSetSoundEventParams
         * @property {number|null} [soundevent_guid] CMsgSosSetSoundEventParams soundevent_guid
         * @property {Uint8Array|null} [packed_params] CMsgSosSetSoundEventParams packed_params
         */
    
        /**
         * Constructs a new CMsgSosSetSoundEventParams.
         * @exports CMsgSosSetSoundEventParams
         * @classdesc Represents a CMsgSosSetSoundEventParams.
         * @implements ICMsgSosSetSoundEventParams
         * @constructor
         * @param {ICMsgSosSetSoundEventParams=} [properties] Properties to set
         */
        ...
        /**
         * CMsgSosSetSoundEventParams soundevent_guid.
         * @member {number} soundevent_guid
         * @memberof CMsgSosSetSoundEventParams
         * @instance
         */
        CMsgSosSetSoundEventParams.prototype.soundevent_guid = 0;
    
        /**
         * CMsgSosSetSoundEventParams packed_params.
         * @member {Uint8Array} packed_params
         * @memberof CMsgSosSetSoundEventParams
         * @instance
         */
        CMsgSosSetSoundEventParams.prototype.packed_params = $util.newBuffer([]);
    
        /**
         * Creates a new CMsgSosSetSoundEventParams instance using the specified properties.
         * @function create
         * @memberof CMsgSosSetSoundEventParams
         * @static
         * @param {ICMsgSosSetSoundEventParams=} [properties] Properties to set
         * @returns {CMsgSosSetSoundEventParams} CMsgSosSetSoundEventParams instance
         */
        CMsgSosSetSoundEventParams.create = function create(properties) {
            return new CMsgSosSetSoundEventParams(properties);
        };
    
        /**
         * Encodes the specified CMsgSosSetSoundEventParams message. Does not implicitly {@link CMsgSosSetSoundEventParams.verify|verify} messages.
         * @function encode
         * @memberof CMsgSosSetSoundEventParams
         * @static
         * @param {ICMsgSosSetSoundEventParams} message CMsgSosSetSoundEventParams message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        ...
        /**
         * Encodes the specified CMsgSosSetSoundEventParams message, length delimited. Does not implicitly {@link CMsgSosSetSoundEventParams.verify|verify} messages.
         * @function encodeDelimited
         * @memberof CMsgSosSetSoundEventParams
         * @static
         * @param {ICMsgSosSetSoundEventParams} message CMsgSosSetSoundEventParams message or plain object to encode
        ...
        /**
         * Decodes a CMsgSosSetSoundEventParams message from the specified reader or buffer.
         * @function decode
         * @memberof CMsgSosSetSoundEventParams
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CMsgSosSetSoundEventParams.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
        ...
        /**
         * Decodes a CMsgSosSetSoundEventParams message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof CMsgSosSetSoundEventParams
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CMsgSosSetSoundEventParams.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a CMsgSosSetSoundEventParams message.
         * @function verify
         * @memberof CMsgSosSetSoundEventParams
         * @static
         * @param {Object.<string,*>} message Plain object to verify
        ...
        /**
         * Creates a CMsgSosSetSoundEventParams message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof CMsgSosSetSoundEventParams
         * @static
         * @param {Object.<string,*>} object Plain object
        ...
        /**
         * Creates a plain object from a CMsgSosSetSoundEventParams message. Also converts values to other types if specified.
         * @function toObject
         * @memberof CMsgSosSetSoundEventParams
         * @static
         * @param {CMsgSosSetSoundEventParams} message CMsgSosSetSoundEventParams
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        ...
        /**
         * Converts this CMsgSosSetSoundEventParams to JSON.
         * @function toJSON
         * @memberof CMsgSosSetSoundEventParams
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        CMsgSosSetSoundEventParams.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
    ...
    $root.CMsgSosSetLibraryStackFields = (function() {
    
        /**
         * Properties of a CMsgSosSetLibraryStackFields.
         * @exports ICMsgSosSetLibraryStackFields
         * @interface ICMsgSosSetLibraryStackFields
         * @property {number|null} [stack_hash] CMsgSosSetLibraryStackFields stack_hash
         * @property {Uint8Array|null} [packed_fields] CMsgSosSetLibraryStackFields packed_fields
         */
    
        /**
         * Constructs a new CMsgSosSetLibraryStackFields.
         * @exports CMsgSosSetLibraryStackFields
         * @classdesc Represents a CMsgSosSetLibraryStackFields.
         * @implements ICMsgSosSetLibraryStackFields
         * @constructor
         * @param {ICMsgSosSetLibraryStackFields=} [properties] Properties to set
         */
        ...
        /**
         * CMsgSosSetLibraryStackFields stack_hash.
         * @member {number} stack_hash
         * @memberof CMsgSosSetLibraryStackFields
         * @instance
         */
        CMsgSosSetLibraryStackFields.prototype.stack_hash = 0;
    
        /**
         * CMsgSosSetLibraryStackFields packed_fields.
         * @member {Uint8Array} packed_fields
         * @memberof CMsgSosSetLibraryStackFields
         * @instance
         */
        CMsgSosSetLibraryStackFields.prototype.packed_fields = $util.newBuffer([]);
    
        /**
         * Creates a new CMsgSosSetLibraryStackFields instance using the specified properties.
         * @function create
         * @memberof CMsgSosSetLibraryStackFields
         * @static
         * @param {ICMsgSosSetLibraryStackFields=} [properties] Properties to set
         * @returns {CMsgSosSetLibraryStackFields} CMsgSosSetLibraryStackFields instance
         */
        CMsgSosSetLibraryStackFields.create = function create(properties) {
            return new CMsgSosSetLibraryStackFields(properties);
        };
    
        /**
         * Encodes the specified CMsgSosSetLibraryStackFields message. Does not implicitly {@link CMsgSosSetLibraryStackFields.verify|verify} messages.
         * @function encode
         * @memberof CMsgSosSetLibraryStackFields
         * @static
         * @param {ICMsgSosSetLibraryStackFields} message CMsgSosSetLibraryStackFields message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        CMsgSosSetLibraryStackFields.encode = function encode(message, writer) {
            ...
            if (message.packed_fields != null && Object.hasOwnProperty.call(message, "packed_fields"))
                writer.uint32(/* id 5, wireType 2 =*/42).bytes(message.packed_fields);
            return writer;
        };
    
        /**
         * Encodes the specified CMsgSosSetLibraryStackFields message, length delimited. Does not implicitly {@link CMsgSosSetLibraryStackFields.verify|verify} messages.
         * @function encodeDelimited
         * @memberof CMsgSosSetLibraryStackFields
         * @static
         * @param {ICMsgSosSetLibraryStackFields} message CMsgSosSetLibraryStackFields message or plain object to encode
        ...
        /**
         * Decodes a CMsgSosSetLibraryStackFields message from the specified reader or buffer.
         * @function decode
         * @memberof CMsgSosSetLibraryStackFields
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CMsgSosSetLibraryStackFields.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
        ...
        /**
         * Decodes a CMsgSosSetLibraryStackFields message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof CMsgSosSetLibraryStackFields
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CMsgSosSetLibraryStackFields.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a CMsgSosSetLibraryStackFields message.
         * @function verify
         * @memberof CMsgSosSetLibraryStackFields
         * @static
         * @param {Object.<string,*>} message Plain object to verify
        ...
        /**
         * Creates a CMsgSosSetLibraryStackFields message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof CMsgSosSetLibraryStackFields
         * @static
         * @param {Object.<string,*>} object Plain object
        ...
        CMsgSosSetLibraryStackFields.fromObject = function fromObject(object) {
            ...
            if (object.packed_fields != null)
                if (typeof object.packed_fields === "string")
                    $util.base64.decode(object.packed_fields, message.packed_fields = $util.newBuffer($util.base64.length(object.packed_fields)), 0);
                else if (object.packed_fields.length)
                    message.packed_fields = object.packed_fields;
            return message;
        };
    
        /**
         * Creates a plain object from a CMsgSosSetLibraryStackFields message. Also converts values to other types if specified.
         * @function toObject
         * @memberof CMsgSosSetLibraryStackFields
         * @static
         * @param {CMsgSosSetLibraryStackFields} message CMsgSosSetLibraryStackFields
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        ...
        /**
         * Converts this CMsgSosSetLibraryStackFields to JSON.
         * @function toJSON
         * @memberof CMsgSosSetLibraryStackFields
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        CMsgSosSetLibraryStackFields.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
