...
(function(global, factory) { /* global define, require, module */
     ...
     * @exports DOTA_MODIFIER_ENTRY_TYPE
     * @enum {number}
     * @property {number} DOTA_MODIFIER_ENTRY_TYPE_ACTIVE=1 DOTA_MODIFIER_ENTRY_TYPE_ACTIVE value
     * @property {number} DOTA_MODIFIER_ENTRY_TYPE_REMOVED=2 DOTA_MODIFIER_ENTRY_TYPE_REMOVED value
     */
    $root.DOTA_MODIFIER_ENTRY_TYPE = (function() {
        var valuesById = {}, values = Object.create(valuesById);
        values[valuesById[1] = "DOTA_MODIFIER_ENTRY_TYPE_ACTIVE"] = 1;
        values[valuesById[2] = "DOTA_MODIFIER_ENTRY_TYPE_REMOVED"] = 2;
        return values;
    })();
    
    $root.CDOTAModifierBuffTableEntry = (function() {
    
        /**
         * Properties of a CDOTAModifierBuffTableEntry.
         * @exports ICDOTAModifierBuffTableEntry
         * @interface ICDOTAModifierBuffTableEntry
         * @property {DOTA_MODIFIER_ENTRY_TYPE} entry_type CDOTAModifierBuffTableEntry entry_type
         * @property {number} parent CDOTAModifierBuffTableEntry parent
         * @property {number} index CDOTAModifierBuffTableEntry index
         * @property {number} serial_num CDOTAModifierBuffTableEntry serial_num
         * @property {number|null} [modifier_class] CDOTAModifierBuffTableEntry modifier_class
         * @property {number|null} [ability_level] CDOTAModifierBuffTableEntry ability_level
         * @property {number|null} [stack_count] CDOTAModifierBuffTableEntry stack_count
         * @property {number|null} [creation_time] CDOTAModifierBuffTableEntry creation_time
         * @property {number|null} [duration] CDOTAModifierBuffTableEntry duration
         * @property {number|null} [caster] CDOTAModifierBuffTableEntry caster
         * @property {number|null} [ability] CDOTAModifierBuffTableEntry ability
         * @property {number|null} [armor] CDOTAModifierBuffTableEntry armor
         * @property {number|null} [fade_time] CDOTAModifierBuffTableEntry fade_time
         * @property {boolean|null} [subtle] CDOTAModifierBuffTableEntry subtle
         * @property {number|null} [channel_time] CDOTAModifierBuffTableEntry channel_time
         * @property {ICMsgVector|null} [v_start] CDOTAModifierBuffTableEntry v_start
         * @property {ICMsgVector|null} [v_end] CDOTAModifierBuffTableEntry v_end
         * @property {string|null} [portal_loop_appear] CDOTAModifierBuffTableEntry portal_loop_appear
         * @property {string|null} [portal_loop_disappear] CDOTAModifierBuffTableEntry portal_loop_disappear
         * @property {string|null} [hero_loop_appear] CDOTAModifierBuffTableEntry hero_loop_appear
         * @property {string|null} [hero_loop_disappear] CDOTAModifierBuffTableEntry hero_loop_disappear
         * @property {number|null} [movement_speed] CDOTAModifierBuffTableEntry movement_speed
         * @property {boolean|null} [aura] CDOTAModifierBuffTableEntry aura
         * @property {number|null} [activity] CDOTAModifierBuffTableEntry activity
         * @property {number|null} [damage] CDOTAModifierBuffTableEntry damage
         * @property {number|null} [range] CDOTAModifierBuffTableEntry range
         * @property {number|null} [dd_modifier_index] CDOTAModifierBuffTableEntry dd_modifier_index
         * @property {number|null} [dd_ability_id] CDOTAModifierBuffTableEntry dd_ability_id
         * @property {string|null} [illusion_label] CDOTAModifierBuffTableEntry illusion_label
         * @property {boolean|null} [active] CDOTAModifierBuffTableEntry active
         * @property {string|null} [player_ids] CDOTAModifierBuffTableEntry player_ids
         * @property {string|null} [lua_name] CDOTAModifierBuffTableEntry lua_name
         * @property {number|null} [attack_speed] CDOTAModifierBuffTableEntry attack_speed
         * @property {number|null} [aura_owner] CDOTAModifierBuffTableEntry aura_owner
         */
    
        /**
         * Constructs a new CDOTAModifierBuffTableEntry.
         * @exports CDOTAModifierBuffTableEntry
         * @classdesc Represents a CDOTAModifierBuffTableEntry.
         * @implements ICDOTAModifierBuffTableEntry
         * @constructor
         * @param {ICDOTAModifierBuffTableEntry=} [properties] Properties to set
         */
        function CDOTAModifierBuffTableEntry(properties) {
            if (properties)
        ...
        /**
         * CDOTAModifierBuffTableEntry entry_type.
         * @member {DOTA_MODIFIER_ENTRY_TYPE} entry_type
         * @memberof CDOTAModifierBuffTableEntry
         * @instance
         */
        CDOTAModifierBuffTableEntry.prototype.entry_type = 1;
    
        /**
         * CDOTAModifierBuffTableEntry parent.
         * @member {number} parent
         * @memberof CDOTAModifierBuffTableEntry
         * @instance
         */
        CDOTAModifierBuffTableEntry.prototype.parent = 0;
    
        /**
         * CDOTAModifierBuffTableEntry index.
         * @member {number} index
         * @memberof CDOTAModifierBuffTableEntry
         * @instance
         */
        CDOTAModifierBuffTableEntry.prototype.index = 0;
    
        /**
         * CDOTAModifierBuffTableEntry serial_num.
         * @member {number} serial_num
         * @memberof CDOTAModifierBuffTableEntry
         * @instance
         */
        CDOTAModifierBuffTableEntry.prototype.serial_num = 0;
    
        /**
         * CDOTAModifierBuffTableEntry modifier_class.
         * @member {number} modifier_class
         * @memberof CDOTAModifierBuffTableEntry
         * @instance
         */
        CDOTAModifierBuffTableEntry.prototype.modifier_class = 0;
    
        /**
         * CDOTAModifierBuffTableEntry ability_level.
         * @member {number} ability_level
         * @memberof CDOTAModifierBuffTableEntry
         * @instance
         */
        CDOTAModifierBuffTableEntry.prototype.ability_level = 0;
    
        /**
         * CDOTAModifierBuffTableEntry stack_count.
         * @member {number} stack_count
         * @memberof CDOTAModifierBuffTableEntry
         * @instance
         */
        CDOTAModifierBuffTableEntry.prototype.stack_count = 0;
    
        /**
         * CDOTAModifierBuffTableEntry creation_time.
         * @member {number} creation_time
         * @memberof CDOTAModifierBuffTableEntry
         * @instance
         */
        CDOTAModifierBuffTableEntry.prototype.creation_time = 0;
    
        /**
         * CDOTAModifierBuffTableEntry duration.
         * @member {number} duration
         * @memberof CDOTAModifierBuffTableEntry
         * @instance
         */
        CDOTAModifierBuffTableEntry.prototype.duration = -1;
    
        /**
         * CDOTAModifierBuffTableEntry caster.
         * @member {number} caster
         * @memberof CDOTAModifierBuffTableEntry
         * @instance
         */
        CDOTAModifierBuffTableEntry.prototype.caster = 0;
    
        /**
         * CDOTAModifierBuffTableEntry ability.
         * @member {number} ability
         * @memberof CDOTAModifierBuffTableEntry
         * @instance
         */
        CDOTAModifierBuffTableEntry.prototype.ability = 0;
    
        /**
         * CDOTAModifierBuffTableEntry armor.
         * @member {number} armor
         * @memberof CDOTAModifierBuffTableEntry
         * @instance
         */
        CDOTAModifierBuffTableEntry.prototype.armor = 0;
    
        /**
         * CDOTAModifierBuffTableEntry fade_time.
         * @member {number} fade_time
         * @memberof CDOTAModifierBuffTableEntry
         * @instance
         */
        CDOTAModifierBuffTableEntry.prototype.fade_time = 0;
    
        /**
         * CDOTAModifierBuffTableEntry subtle.
         * @member {boolean} subtle
         * @memberof CDOTAModifierBuffTableEntry
         * @instance
         */
        CDOTAModifierBuffTableEntry.prototype.subtle = false;
    
        /**
         * CDOTAModifierBuffTableEntry channel_time.
         * @member {number} channel_time
         * @memberof CDOTAModifierBuffTableEntry
         * @instance
         */
        CDOTAModifierBuffTableEntry.prototype.channel_time = 0;
    
        /**
         * CDOTAModifierBuffTableEntry v_start.
         * @member {ICMsgVector|null|undefined} v_start
         * @memberof CDOTAModifierBuffTableEntry
         * @instance
         */
        CDOTAModifierBuffTableEntry.prototype.v_start = null;
    
        /**
         * CDOTAModifierBuffTableEntry v_end.
         * @member {ICMsgVector|null|undefined} v_end
         * @memberof CDOTAModifierBuffTableEntry
         * @instance
         */
        CDOTAModifierBuffTableEntry.prototype.v_end = null;
    
        /**
         * CDOTAModifierBuffTableEntry portal_loop_appear.
         * @member {string} portal_loop_appear
         * @memberof CDOTAModifierBuffTableEntry
         * @instance
         */
        CDOTAModifierBuffTableEntry.prototype.portal_loop_appear = "";
    
        /**
         * CDOTAModifierBuffTableEntry portal_loop_disappear.
         * @member {string} portal_loop_disappear
         * @memberof CDOTAModifierBuffTableEntry
         * @instance
         */
        CDOTAModifierBuffTableEntry.prototype.portal_loop_disappear = "";
    
        /**
         * CDOTAModifierBuffTableEntry hero_loop_appear.
         * @member {string} hero_loop_appear
         * @memberof CDOTAModifierBuffTableEntry
         * @instance
         */
        CDOTAModifierBuffTableEntry.prototype.hero_loop_appear = "";
    
        /**
         * CDOTAModifierBuffTableEntry hero_loop_disappear.
         * @member {string} hero_loop_disappear
         * @memberof CDOTAModifierBuffTableEntry
         * @instance
         */
        CDOTAModifierBuffTableEntry.prototype.hero_loop_disappear = "";
    
        /**
         * CDOTAModifierBuffTableEntry movement_speed.
         * @member {number} movement_speed
         * @memberof CDOTAModifierBuffTableEntry
         * @instance
         */
        CDOTAModifierBuffTableEntry.prototype.movement_speed = 0;
    
        /**
         * CDOTAModifierBuffTableEntry aura.
         * @member {boolean} aura
         * @memberof CDOTAModifierBuffTableEntry
         * @instance
         */
        CDOTAModifierBuffTableEntry.prototype.aura = false;
    
        /**
         * CDOTAModifierBuffTableEntry activity.
         * @member {number} activity
         * @memberof CDOTAModifierBuffTableEntry
         * @instance
         */
        CDOTAModifierBuffTableEntry.prototype.activity = 0;
    
        /**
         * CDOTAModifierBuffTableEntry damage.
         * @member {number} damage
         * @memberof CDOTAModifierBuffTableEntry
         * @instance
         */
        CDOTAModifierBuffTableEntry.prototype.damage = 0;
    
        /**
         * CDOTAModifierBuffTableEntry range.
         * @member {number} range
         * @memberof CDOTAModifierBuffTableEntry
         * @instance
         */
        CDOTAModifierBuffTableEntry.prototype.range = 0;
    
        /**
         * CDOTAModifierBuffTableEntry dd_modifier_index.
         * @member {number} dd_modifier_index
         * @memberof CDOTAModifierBuffTableEntry
         * @instance
         */
        CDOTAModifierBuffTableEntry.prototype.dd_modifier_index = 0;
    
        /**
         * CDOTAModifierBuffTableEntry dd_ability_id.
         * @member {number} dd_ability_id
         * @memberof CDOTAModifierBuffTableEntry
         * @instance
         */
        CDOTAModifierBuffTableEntry.prototype.dd_ability_id = 0;
    
        /**
         * CDOTAModifierBuffTableEntry illusion_label.
         * @member {string} illusion_label
         * @memberof CDOTAModifierBuffTableEntry
         * @instance
         */
        CDOTAModifierBuffTableEntry.prototype.illusion_label = "";
    
        /**
         * CDOTAModifierBuffTableEntry active.
         * @member {boolean} active
         * @memberof CDOTAModifierBuffTableEntry
         * @instance
         */
        CDOTAModifierBuffTableEntry.prototype.active = false;
    
        /**
         * CDOTAModifierBuffTableEntry player_ids.
         * @member {string} player_ids
         * @memberof CDOTAModifierBuffTableEntry
         * @instance
         */
        CDOTAModifierBuffTableEntry.prototype.player_ids = "";
    
        /**
         * CDOTAModifierBuffTableEntry lua_name.
         * @member {string} lua_name
         * @memberof CDOTAModifierBuffTableEntry
         * @instance
         */
        CDOTAModifierBuffTableEntry.prototype.lua_name = "";
    
        /**
         * CDOTAModifierBuffTableEntry attack_speed.
         * @member {number} attack_speed
         * @memberof CDOTAModifierBuffTableEntry
         * @instance
         */
        CDOTAModifierBuffTableEntry.prototype.attack_speed = 0;
    
        /**
         * CDOTAModifierBuffTableEntry aura_owner.
         * @member {number} aura_owner
         * @memberof CDOTAModifierBuffTableEntry
         * @instance
         */
        CDOTAModifierBuffTableEntry.prototype.aura_owner = 0;
    
        /**
         * Creates a new CDOTAModifierBuffTableEntry instance using the specified properties.
         * @function create
         * @memberof CDOTAModifierBuffTableEntry
         * @static
         * @param {ICDOTAModifierBuffTableEntry=} [properties] Properties to set
         * @returns {CDOTAModifierBuffTableEntry} CDOTAModifierBuffTableEntry instance
         */
        CDOTAModifierBuffTableEntry.create = function create(properties) {
            return new CDOTAModifierBuffTableEntry(properties);
        };
    
        /**
         * Encodes the specified CDOTAModifierBuffTableEntry message. Does not implicitly {@link CDOTAModifierBuffTableEntry.verify|verify} messages.
         * @function encode
         * @memberof CDOTAModifierBuffTableEntry
         * @static
         * @param {ICDOTAModifierBuffTableEntry} message CDOTAModifierBuffTableEntry message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        CDOTAModifierBuffTableEntry.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            writer.uint32(/* id 1, wireType 0 =*/8).int32(message.entry_type);
            writer.uint32(/* id 2, wireType 0 =*/16).int32(message.parent);
            writer.uint32(/* id 3, wireType 0 =*/24).int32(message.index);
            writer.uint32(/* id 4, wireType 0 =*/32).int32(message.serial_num);
            if (message.modifier_class != null && Object.hasOwnProperty.call(message, "modifier_class"))
                writer.uint32(/* id 5, wireType 0 =*/40).int32(message.modifier_class);
            if (message.ability_level != null && Object.hasOwnProperty.call(message, "ability_level"))
                writer.uint32(/* id 6, wireType 0 =*/48).int32(message.ability_level);
            if (message.stack_count != null && Object.hasOwnProperty.call(message, "stack_count"))
                writer.uint32(/* id 7, wireType 0 =*/56).int32(message.stack_count);
            if (message.creation_time != null && Object.hasOwnProperty.call(message, "creation_time"))
                writer.uint32(/* id 8, wireType 5 =*/69).float(message.creation_time);
            ...
            if (message.caster != null && Object.hasOwnProperty.call(message, "caster"))
                writer.uint32(/* id 10, wireType 0 =*/80).int32(message.caster);
            if (message.ability != null && Object.hasOwnProperty.call(message, "ability"))
                writer.uint32(/* id 11, wireType 0 =*/88).int32(message.ability);
            if (message.armor != null && Object.hasOwnProperty.call(message, "armor"))
                writer.uint32(/* id 12, wireType 0 =*/96).int32(message.armor);
            if (message.fade_time != null && Object.hasOwnProperty.call(message, "fade_time"))
                writer.uint32(/* id 13, wireType 5 =*/109).float(message.fade_time);
            if (message.subtle != null && Object.hasOwnProperty.call(message, "subtle"))
                writer.uint32(/* id 14, wireType 0 =*/112).bool(message.subtle);
            if (message.channel_time != null && Object.hasOwnProperty.call(message, "channel_time"))
                writer.uint32(/* id 15, wireType 5 =*/125).float(message.channel_time);
            if (message.v_start != null && Object.hasOwnProperty.call(message, "v_start"))
                $root.CMsgVector.encode(message.v_start, writer.uint32(/* id 16, wireType 2 =*/130).fork()).ldelim();
            if (message.v_end != null && Object.hasOwnProperty.call(message, "v_end"))
                $root.CMsgVector.encode(message.v_end, writer.uint32(/* id 17, wireType 2 =*/138).fork()).ldelim();
            if (message.portal_loop_appear != null && Object.hasOwnProperty.call(message, "portal_loop_appear"))
                writer.uint32(/* id 18, wireType 2 =*/146).string(message.portal_loop_appear);
            if (message.portal_loop_disappear != null && Object.hasOwnProperty.call(message, "portal_loop_disappear"))
                writer.uint32(/* id 19, wireType 2 =*/154).string(message.portal_loop_disappear);
            if (message.hero_loop_appear != null && Object.hasOwnProperty.call(message, "hero_loop_appear"))
                writer.uint32(/* id 20, wireType 2 =*/162).string(message.hero_loop_appear);
            if (message.hero_loop_disappear != null && Object.hasOwnProperty.call(message, "hero_loop_disappear"))
                writer.uint32(/* id 21, wireType 2 =*/170).string(message.hero_loop_disappear);
            if (message.movement_speed != null && Object.hasOwnProperty.call(message, "movement_speed"))
                writer.uint32(/* id 22, wireType 0 =*/176).int32(message.movement_speed);
            if (message.aura != null && Object.hasOwnProperty.call(message, "aura"))
                writer.uint32(/* id 23, wireType 0 =*/184).bool(message.aura);
            if (message.activity != null && Object.hasOwnProperty.call(message, "activity"))
                writer.uint32(/* id 24, wireType 0 =*/192).int32(message.activity);
            if (message.damage != null && Object.hasOwnProperty.call(message, "damage"))
                writer.uint32(/* id 25, wireType 0 =*/200).int32(message.damage);
            if (message.range != null && Object.hasOwnProperty.call(message, "range"))
                writer.uint32(/* id 26, wireType 0 =*/208).int32(message.range);
            if (message.dd_modifier_index != null && Object.hasOwnProperty.call(message, "dd_modifier_index"))
                writer.uint32(/* id 27, wireType 0 =*/216).int32(message.dd_modifier_index);
            if (message.dd_ability_id != null && Object.hasOwnProperty.call(message, "dd_ability_id"))
                writer.uint32(/* id 28, wireType 0 =*/224).int32(message.dd_ability_id);
            if (message.illusion_label != null && Object.hasOwnProperty.call(message, "illusion_label"))
                writer.uint32(/* id 29, wireType 2 =*/234).string(message.illusion_label);
            if (message.active != null && Object.hasOwnProperty.call(message, "active"))
                writer.uint32(/* id 30, wireType 0 =*/240).bool(message.active);
            if (message.player_ids != null && Object.hasOwnProperty.call(message, "player_ids"))
                writer.uint32(/* id 31, wireType 2 =*/250).string(message.player_ids);
            if (message.lua_name != null && Object.hasOwnProperty.call(message, "lua_name"))
                writer.uint32(/* id 32, wireType 2 =*/258).string(message.lua_name);
            if (message.attack_speed != null && Object.hasOwnProperty.call(message, "attack_speed"))
                writer.uint32(/* id 33, wireType 0 =*/264).int32(message.attack_speed);
            if (message.aura_owner != null && Object.hasOwnProperty.call(message, "aura_owner"))
                writer.uint32(/* id 34, wireType 0 =*/272).int32(message.aura_owner);
            return writer;
        };
    
        /**
         * Encodes the specified CDOTAModifierBuffTableEntry message, length delimited. Does not implicitly {@link CDOTAModifierBuffTableEntry.verify|verify} messages.
         ...
         * @returns {$protobuf.Writer} Writer
         */
        CDOTAModifierBuffTableEntry.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
    
        /**
         * Decodes a CDOTAModifierBuffTableEntry message from the specified reader or buffer.
         * @function decode
         * @memberof CDOTAModifierBuffTableEntry
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {CDOTAModifierBuffTableEntry} CDOTAModifierBuffTableEntry
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CDOTAModifierBuffTableEntry.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.CDOTAModifierBuffTableEntry();
            while (reader.pos < end) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    message.serial_num = reader.int32();
                    break;
                case 5:
                    message.modifier_class = reader.int32();
                    break;
                case 6:
                    message.ability_level = reader.int32();
                    break;
                case 7:
                    message.stack_count = reader.int32();
                    break;
                case 8:
                    message.creation_time = reader.float();
                    break;
                case 9:
                    message.duration = reader.float();
                    break;
                case 10:
                    message.caster = reader.int32();
                    break;
                case 11:
                ...
                case 12:
                    ...
                    break;
                case 13:
                    message.fade_time = reader.float();
                    break;
                case 14:
                ...
                case 15:
                    ...
                    break;
                case 16:
                    message.v_start = $root.CMsgVector.decode(reader, reader.uint32());
                    break;
                case 17:
                    message.v_end = $root.CMsgVector.decode(reader, reader.uint32());
                    break;
                case 18:
                    message.portal_loop_appear = reader.string();
                    break;
                case 19:
                    message.portal_loop_disappear = reader.string();
                    break;
                case 20:
                    message.hero_loop_appear = reader.string();
                    break;
                case 21:
                    message.hero_loop_disappear = reader.string();
                    break;
                case 22:
                    message.movement_speed = reader.int32();
                    break;
                case 23:
                ...
                case 26:
                    ...
                    break;
                case 27:
                    message.dd_modifier_index = reader.int32();
                    break;
                case 28:
                    message.dd_ability_id = reader.int32();
                    break;
                case 29:
                    message.illusion_label = reader.string();
                    break;
                case 30:
                    message.active = reader.bool();
                    break;
                case 31:
                    message.player_ids = reader.string();
                    break;
                case 32:
                    message.lua_name = reader.string();
                    break;
                case 33:
                    message.attack_speed = reader.int32();
                    break;
                case 34:
                    message.aura_owner = reader.int32();
                    break;
                default:
            ...
            if (!message.hasOwnProperty("entry_type"))
                throw $util.ProtocolError("missing required 'entry_type'", { instance: message });
            ...
            if (!message.hasOwnProperty("serial_num"))
                throw $util.ProtocolError("missing required 'serial_num'", { instance: message });
            return message;
        };
    
        /**
         * Decodes a CDOTAModifierBuffTableEntry message from the specified reader or buffer, length delimited.
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CDOTAModifierBuffTableEntry.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
        ...
        /**
         * Verifies a CDOTAModifierBuffTableEntry message.
         * @function verify
         * @memberof CDOTAModifierBuffTableEntry
         * @static
         ...
         */
        CDOTAModifierBuffTableEntry.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            switch (message.entry_type) {
            default:
                return "entry_type: enum value expected";
            case 1:
            case 2:
                break;
            }
            ...
            if (!$util.isInteger(message.serial_num))
                return "serial_num: integer expected";
            if (message.modifier_class != null && message.hasOwnProperty("modifier_class"))
                if (!$util.isInteger(message.modifier_class))
                    return "modifier_class: integer expected";
            ...
            if (message.creation_time != null && message.hasOwnProperty("creation_time"))
                if (typeof message.creation_time !== "number")
                    return "creation_time: number expected";
            ...
            if (message.fade_time != null && message.hasOwnProperty("fade_time"))
                if (typeof message.fade_time !== "number")
                    return "fade_time: number expected";
            if (message.subtle != null && message.hasOwnProperty("subtle"))
                if (typeof message.subtle !== "boolean")
                    return "subtle: boolean expected";
            ...
            if (message.v_start != null && message.hasOwnProperty("v_start")) {
                var error = $root.CMsgVector.verify(message.v_start);
                if (error)
                    return "v_start." + error;
            }
            if (message.v_end != null && message.hasOwnProperty("v_end")) {
                var error = $root.CMsgVector.verify(message.v_end);
                if (error)
                    return "v_end." + error;
            }
            if (message.portal_loop_appear != null && message.hasOwnProperty("portal_loop_appear"))
                if (!$util.isString(message.portal_loop_appear))
                    return "portal_loop_appear: string expected";
            if (message.portal_loop_disappear != null && message.hasOwnProperty("portal_loop_disappear"))
                if (!$util.isString(message.portal_loop_disappear))
                    return "portal_loop_disappear: string expected";
            if (message.hero_loop_appear != null && message.hasOwnProperty("hero_loop_appear"))
                if (!$util.isString(message.hero_loop_appear))
                    return "hero_loop_appear: string expected";
            if (message.hero_loop_disappear != null && message.hasOwnProperty("hero_loop_disappear"))
                if (!$util.isString(message.hero_loop_disappear))
                    return "hero_loop_disappear: string expected";
            if (message.movement_speed != null && message.hasOwnProperty("movement_speed"))
                if (!$util.isInteger(message.movement_speed))
                    return "movement_speed: integer expected";
            ...
            if (message.dd_modifier_index != null && message.hasOwnProperty("dd_modifier_index"))
                if (!$util.isInteger(message.dd_modifier_index))
                    return "dd_modifier_index: integer expected";
            if (message.dd_ability_id != null && message.hasOwnProperty("dd_ability_id"))
                if (!$util.isInteger(message.dd_ability_id))
                    return "dd_ability_id: integer expected";
            if (message.illusion_label != null && message.hasOwnProperty("illusion_label"))
                if (!$util.isString(message.illusion_label))
                    return "illusion_label: string expected";
            if (message.active != null && message.hasOwnProperty("active"))
                if (typeof message.active !== "boolean")
                    return "active: boolean expected";
            if (message.player_ids != null && message.hasOwnProperty("player_ids"))
                if (!$util.isString(message.player_ids))
                    return "player_ids: string expected";
            if (message.lua_name != null && message.hasOwnProperty("lua_name"))
                if (!$util.isString(message.lua_name))
                    return "lua_name: string expected";
            if (message.attack_speed != null && message.hasOwnProperty("attack_speed"))
                if (!$util.isInteger(message.attack_speed))
                    return "attack_speed: integer expected";
            if (message.aura_owner != null && message.hasOwnProperty("aura_owner"))
                if (!$util.isInteger(message.aura_owner))
                    return "aura_owner: integer expected";
            return null;
        };
    
        /**
         * Creates a CDOTAModifierBuffTableEntry message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof CDOTAModifierBuffTableEntry
         * @static
         ...
         * @returns {CDOTAModifierBuffTableEntry} CDOTAModifierBuffTableEntry
         */
        CDOTAModifierBuffTableEntry.fromObject = function fromObject(object) {
            if (object instanceof $root.CDOTAModifierBuffTableEntry)
                return object;
            var message = new $root.CDOTAModifierBuffTableEntry();
            switch (object.entry_type) {
            case "DOTA_MODIFIER_ENTRY_TYPE_ACTIVE":
            case 1:
                message.entry_type = 1;
                break;
            case "DOTA_MODIFIER_ENTRY_TYPE_REMOVED":
            case 2:
                message.entry_type = 2;
                break;
            }
            ...
            if (object.serial_num != null)
                message.serial_num = object.serial_num | 0;
            if (object.modifier_class != null)
                message.modifier_class = object.modifier_class | 0;
            ...
            if (object.creation_time != null)
                message.creation_time = Number(object.creation_time);
            ...
            if (object.fade_time != null)
                message.fade_time = Number(object.fade_time);
            if (object.subtle != null)
                message.subtle = Boolean(object.subtle);
            if (object.channel_time != null)
                message.channel_time = Number(object.channel_time);
            if (object.v_start != null) {
                if (typeof object.v_start !== "object")
                    throw TypeError(".CDOTAModifierBuffTableEntry.v_start: object expected");
                message.v_start = $root.CMsgVector.fromObject(object.v_start);
            }
            if (object.v_end != null) {
                if (typeof object.v_end !== "object")
                    throw TypeError(".CDOTAModifierBuffTableEntry.v_end: object expected");
                message.v_end = $root.CMsgVector.fromObject(object.v_end);
            }
            if (object.portal_loop_appear != null)
                message.portal_loop_appear = String(object.portal_loop_appear);
            if (object.portal_loop_disappear != null)
                message.portal_loop_disappear = String(object.portal_loop_disappear);
            if (object.hero_loop_appear != null)
                message.hero_loop_appear = String(object.hero_loop_appear);
            if (object.hero_loop_disappear != null)
                message.hero_loop_disappear = String(object.hero_loop_disappear);
            if (object.movement_speed != null)
                message.movement_speed = object.movement_speed | 0;
            if (object.aura != null)
            ...
            if (object.dd_modifier_index != null)
                message.dd_modifier_index = object.dd_modifier_index | 0;
            if (object.dd_ability_id != null)
                message.dd_ability_id = object.dd_ability_id | 0;
            if (object.illusion_label != null)
                message.illusion_label = String(object.illusion_label);
            if (object.active != null)
                message.active = Boolean(object.active);
            if (object.player_ids != null)
                message.player_ids = String(object.player_ids);
            if (object.lua_name != null)
                message.lua_name = String(object.lua_name);
            if (object.attack_speed != null)
                message.attack_speed = object.attack_speed | 0;
            if (object.aura_owner != null)
                message.aura_owner = object.aura_owner | 0;
            return message;
        };
    
        /**
         * Creates a plain object from a CDOTAModifierBuffTableEntry message. Also converts values to other types if specified.
         * @function toObject
         * @memberof CDOTAModifierBuffTableEntry
         * @static
         * @param {CDOTAModifierBuffTableEntry} message CDOTAModifierBuffTableEntry
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        CDOTAModifierBuffTableEntry.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
                object.entry_type = options.enums === String ? "DOTA_MODIFIER_ENTRY_TYPE_ACTIVE" : 1;
                object.parent = 0;
                object.index = 0;
                object.serial_num = 0;
                object.modifier_class = 0;
                ...
                object.v_start = null;
                object.v_end = null;
                object.portal_loop_appear = "";
                object.portal_loop_disappear = "";
                object.hero_loop_appear = "";
                object.hero_loop_disappear = "";
                object.movement_speed = 0;
                object.aura = false;
                object.activity = 0;
                object.damage = 0;
                object.range = 0;
                object.dd_modifier_index = 0;
                object.dd_ability_id = 0;
                object.illusion_label = "";
                object.active = false;
                object.player_ids = "";
                object.lua_name = "";
            ...
            if (message.entry_type != null && message.hasOwnProperty("entry_type"))
                object.entry_type = options.enums === String ? $root.DOTA_MODIFIER_ENTRY_TYPE[message.entry_type] : message.entry_type;
            if (message.parent != null && message.hasOwnProperty("parent"))
                object.parent = message.parent;
            if (message.index != null && message.hasOwnProperty("index"))
                object.index = message.index;
            if (message.serial_num != null && message.hasOwnProperty("serial_num"))
                object.serial_num = message.serial_num;
            if (message.modifier_class != null && message.hasOwnProperty("modifier_class"))
                object.modifier_class = message.modifier_class;
            if (message.ability_level != null && message.hasOwnProperty("ability_level"))
                object.ability_level = message.ability_level;
            if (message.stack_count != null && message.hasOwnProperty("stack_count"))
                object.stack_count = message.stack_count;
            if (message.creation_time != null && message.hasOwnProperty("creation_time"))
                object.creation_time = options.json && !isFinite(message.creation_time) ? String(message.creation_time) : message.creation_time;
            if (message.duration != null && message.hasOwnProperty("duration"))
            ...
            if (message.fade_time != null && message.hasOwnProperty("fade_time"))
                object.fade_time = options.json && !isFinite(message.fade_time) ? String(message.fade_time) : message.fade_time;
            if (message.subtle != null && message.hasOwnProperty("subtle"))
                object.subtle = message.subtle;
            if (message.channel_time != null && message.hasOwnProperty("channel_time"))
                object.channel_time = options.json && !isFinite(message.channel_time) ? String(message.channel_time) : message.channel_time;
            if (message.v_start != null && message.hasOwnProperty("v_start"))
                object.v_start = $root.CMsgVector.toObject(message.v_start, options);
            if (message.v_end != null && message.hasOwnProperty("v_end"))
                object.v_end = $root.CMsgVector.toObject(message.v_end, options);
            if (message.portal_loop_appear != null && message.hasOwnProperty("portal_loop_appear"))
                object.portal_loop_appear = message.portal_loop_appear;
            if (message.portal_loop_disappear != null && message.hasOwnProperty("portal_loop_disappear"))
                object.portal_loop_disappear = message.portal_loop_disappear;
            if (message.hero_loop_appear != null && message.hasOwnProperty("hero_loop_appear"))
                object.hero_loop_appear = message.hero_loop_appear;
            if (message.hero_loop_disappear != null && message.hasOwnProperty("hero_loop_disappear"))
                object.hero_loop_disappear = message.hero_loop_disappear;
            if (message.movement_speed != null && message.hasOwnProperty("movement_speed"))
                object.movement_speed = message.movement_speed;
            if (message.aura != null && message.hasOwnProperty("aura"))
            ...
            if (message.dd_modifier_index != null && message.hasOwnProperty("dd_modifier_index"))
                object.dd_modifier_index = message.dd_modifier_index;
            if (message.dd_ability_id != null && message.hasOwnProperty("dd_ability_id"))
                object.dd_ability_id = message.dd_ability_id;
            if (message.illusion_label != null && message.hasOwnProperty("illusion_label"))
                object.illusion_label = message.illusion_label;
            if (message.active != null && message.hasOwnProperty("active"))
                object.active = message.active;
            if (message.player_ids != null && message.hasOwnProperty("player_ids"))
                object.player_ids = message.player_ids;
            if (message.lua_name != null && message.hasOwnProperty("lua_name"))
                object.lua_name = message.lua_name;
            if (message.attack_speed != null && message.hasOwnProperty("attack_speed"))
                object.attack_speed = message.attack_speed;
            if (message.aura_owner != null && message.hasOwnProperty("aura_owner"))
                object.aura_owner = message.aura_owner;
            return object;
        };
    
        /**
         * Converts this CDOTAModifierBuffTableEntry to JSON.
         * @function toJSON
         * @memberof CDOTAModifierBuffTableEntry
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        CDOTAModifierBuffTableEntry.prototype.toJSON = function toJSON() {
    ...
    $root.CDOTALuaModifierEntry = (function() {
    
        /**
         * Properties of a CDOTALuaModifierEntry.
         * @exports ICDOTALuaModifierEntry
         * @interface ICDOTALuaModifierEntry
         * @property {number} modifier_type CDOTALuaModifierEntry modifier_type
         * @property {string} modifier_filename CDOTALuaModifierEntry modifier_filename
         */
    
        /**
         * Constructs a new CDOTALuaModifierEntry.
         * @exports CDOTALuaModifierEntry
         * @classdesc Represents a CDOTALuaModifierEntry.
         * @implements ICDOTALuaModifierEntry
         * @constructor
         * @param {ICDOTALuaModifierEntry=} [properties] Properties to set
         */
        function CDOTALuaModifierEntry(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
        ...
        /**
         * CDOTALuaModifierEntry modifier_type.
         * @member {number} modifier_type
         * @memberof CDOTALuaModifierEntry
         * @instance
         */
        CDOTALuaModifierEntry.prototype.modifier_type = 0;
    
        /**
         * CDOTALuaModifierEntry modifier_filename.
         * @member {string} modifier_filename
         * @memberof CDOTALuaModifierEntry
         * @instance
         */
        CDOTALuaModifierEntry.prototype.modifier_filename = "";
    
        /**
         * Creates a new CDOTALuaModifierEntry instance using the specified properties.
         * @function create
         * @memberof CDOTALuaModifierEntry
         * @static
         * @param {ICDOTALuaModifierEntry=} [properties] Properties to set
         * @returns {CDOTALuaModifierEntry} CDOTALuaModifierEntry instance
         */
        CDOTALuaModifierEntry.create = function create(properties) {
            return new CDOTALuaModifierEntry(properties);
        };
    
        /**
         * Encodes the specified CDOTALuaModifierEntry message. Does not implicitly {@link CDOTALuaModifierEntry.verify|verify} messages.
         * @function encode
         * @memberof CDOTALuaModifierEntry
         * @static
         * @param {ICDOTALuaModifierEntry} message CDOTALuaModifierEntry message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        CDOTALuaModifierEntry.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            writer.uint32(/* id 1, wireType 0 =*/8).int32(message.modifier_type);
            writer.uint32(/* id 2, wireType 2 =*/18).string(message.modifier_filename);
            return writer;
        };
    
        /**
         * Encodes the specified CDOTALuaModifierEntry message, length delimited. Does not implicitly {@link CDOTALuaModifierEntry.verify|verify} messages.
         * @function encodeDelimited
         * @memberof CDOTALuaModifierEntry
         * @static
         * @param {ICDOTALuaModifierEntry} message CDOTALuaModifierEntry message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        CDOTALuaModifierEntry.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
    
        /**
         * Decodes a CDOTALuaModifierEntry message from the specified reader or buffer.
         * @function decode
         * @memberof CDOTALuaModifierEntry
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {CDOTALuaModifierEntry} CDOTALuaModifierEntry
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CDOTALuaModifierEntry.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.CDOTALuaModifierEntry();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
                    message.modifier_type = reader.int32();
                    break;
                case 2:
                    message.modifier_filename = reader.string();
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
            ...
            if (!message.hasOwnProperty("modifier_type"))
                throw $util.ProtocolError("missing required 'modifier_type'", { instance: message });
            if (!message.hasOwnProperty("modifier_filename"))
                throw $util.ProtocolError("missing required 'modifier_filename'", { instance: message });
            return message;
        };
    
        /**
         * Decodes a CDOTALuaModifierEntry message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof CDOTALuaModifierEntry
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CDOTALuaModifierEntry.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a CDOTALuaModifierEntry message.
         * @function verify
         * @memberof CDOTALuaModifierEntry
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        CDOTALuaModifierEntry.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (!$util.isInteger(message.modifier_type))
                return "modifier_type: integer expected";
            if (!$util.isString(message.modifier_filename))
                return "modifier_filename: string expected";
            return null;
        };
    
        /**
         * Creates a CDOTALuaModifierEntry message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof CDOTALuaModifierEntry
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {CDOTALuaModifierEntry} CDOTALuaModifierEntry
         */
        CDOTALuaModifierEntry.fromObject = function fromObject(object) {
            if (object instanceof $root.CDOTALuaModifierEntry)
                return object;
            var message = new $root.CDOTALuaModifierEntry();
            if (object.modifier_type != null)
                message.modifier_type = object.modifier_type | 0;
            if (object.modifier_filename != null)
                message.modifier_filename = String(object.modifier_filename);
            return message;
        };
    
        /**
         * Creates a plain object from a CDOTALuaModifierEntry message. Also converts values to other types if specified.
         * @function toObject
         * @memberof CDOTALuaModifierEntry
         * @static
         * @param {CDOTALuaModifierEntry} message CDOTALuaModifierEntry
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        CDOTALuaModifierEntry.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
                object.modifier_type = 0;
                object.modifier_filename = "";
            }
            if (message.modifier_type != null && message.hasOwnProperty("modifier_type"))
                object.modifier_type = message.modifier_type;
            if (message.modifier_filename != null && message.hasOwnProperty("modifier_filename"))
                object.modifier_filename = message.modifier_filename;
            return object;
        };
    
        /**
         * Converts this CDOTALuaModifierEntry to JSON.
         * @function toJSON
         * @memberof CDOTALuaModifierEntry
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        CDOTALuaModifierEntry.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };
